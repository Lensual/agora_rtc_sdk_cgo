 ...
 * The channel profile.
 */
type CHANNEL_PROFILE_TYPE C.enum_C_CHANNEL_PROFILE_TYPE
...
const (
	 ...
	 */
	CHANNEL_PROFILE_COMMUNICATION CHANNEL_PROFILE_TYPE = C.CHANNEL_PROFILE_COMMUNICATION
	/**
	 * 1: (Default) Live Broadcast.
	 *
	 * This profile prioritizes supporting a large audience in a live broadcast channel.
	 */
	CHANNEL_PROFILE_LIVE_BROADCASTING CHANNEL_PROFILE_TYPE = C.CHANNEL_PROFILE_LIVE_BROADCASTING
	/**
	 * 2: Gaming.
 ...
 * The warning codes.
 */
type WARN_CODE_TYPE C.enum_C_WARN_CODE_TYPE
...
const (
	 ...
	 * a valid view.
	 */
	WARN_INVALID_VIEW WARN_CODE_TYPE = C.WARN_INVALID_VIEW
	/**
	 ...
	 */
	WARN_LOOKUP_CHANNEL_TIMEOUT WARN_CODE_TYPE = C.WARN_LOOKUP_CHANNEL_TIMEOUT
	/**
	 ...
	 */
	WARN_LOOKUP_CHANNEL_REJECTED WARN_CODE_TYPE = C.WARN_LOOKUP_CHANNEL_REJECTED
	/**
	 ...
	 * network condition is too poor to connect to the server.
	 */
	WARN_OPEN_CHANNEL_TIMEOUT WARN_CODE_TYPE = C.WARN_OPEN_CHANNEL_TIMEOUT
	/**
	 * 107: The server rejects the request to open the channel. The server
	 * cannot process this request or the request is illegal.
	 */
	WARN_OPEN_CHANNEL_REJECTED WARN_CODE_TYPE = C.WARN_OPEN_CHANNEL_REJECTED

	// sdk: 100~1000
	/**
	 * 111: A timeout occurs when switching the live video.
	 */
	WARN_SWITCH_LIVE_VIDEO_TIMEOUT WARN_CODE_TYPE = C.WARN_SWITCH_LIVE_VIDEO_TIMEOUT
	/**
	 * 118: A timeout occurs when setting the user role.
	 */
	WARN_SET_CLIENT_ROLE_TIMEOUT WARN_CODE_TYPE = C.WARN_SET_CLIENT_ROLE_TIMEOUT
	/**
	 * 121: The ticket to open the channel is invalid.
	 */
	WARN_OPEN_CHANNEL_INVALID_TICKET WARN_CODE_TYPE = C.WARN_OPEN_CHANNEL_INVALID_TICKET
	/**
	 * 122: The SDK is trying connecting to another server.
	 */
	WARN_OPEN_CHANNEL_TRY_NEXT_VOS WARN_CODE_TYPE = C.WARN_OPEN_CHANNEL_TRY_NEXT_VOS
	/**
	 * 131: The channel connection cannot be recovered.
	 */
	WARN_CHANNEL_CONNECTION_UNRECOVERABLE WARN_CODE_TYPE = C.WARN_CHANNEL_CONNECTION_UNRECOVERABLE
	/**
	 * 132: The SDK connection IP has changed.
	 */
	WARN_CHANNEL_CONNECTION_IP_CHANGED WARN_CODE_TYPE = C.WARN_CHANNEL_CONNECTION_IP_CHANGED
	/**
	 * 133: The SDK connection port has changed.
	 */
	WARN_CHANNEL_CONNECTION_PORT_CHANGED WARN_CODE_TYPE = C.WARN_CHANNEL_CONNECTION_PORT_CHANGED
	/** 134: The socket error occurs, try to rejoin channel.
	 */
	WARN_CHANNEL_SOCKET_ERROR WARN_CODE_TYPE = C.WARN_CHANNEL_SOCKET_ERROR
	/**
	 * 701: An error occurs when opening the file for audio mixing.
	 */
	WARN_AUDIO_MIXING_OPEN_ERROR WARN_CODE_TYPE = C.WARN_AUDIO_MIXING_OPEN_ERROR
	/**
	 * 1014: Audio Device Module: An exception occurs in the playback device.
	 */
	WARN_ADM_RUNTIME_PLAYOUT_WARNING WARN_CODE_TYPE = C.WARN_ADM_RUNTIME_PLAYOUT_WARNING
	/**
	 * 1016: Audio Device Module: A warning occurs in the recording device.
	 */
	WARN_ADM_RUNTIME_RECORDING_WARNING WARN_CODE_TYPE = C.WARN_ADM_RUNTIME_RECORDING_WARNING
	/**
	 * 1019: Audio Device Module: No valid audio data is collected.
	 */
	WARN_ADM_RECORD_AUDIO_SILENCE WARN_CODE_TYPE = C.WARN_ADM_RECORD_AUDIO_SILENCE
	/**
	 * 1020: Audio Device Module: The playback device fails to start.
	 */
	WARN_ADM_PLAYOUT_MALFUNCTION WARN_CODE_TYPE = C.WARN_ADM_PLAYOUT_MALFUNCTION
	/**
	 * 1021: Audio Device Module: The recording device fails to start.
	 */
	WARN_ADM_RECORD_MALFUNCTION WARN_CODE_TYPE = C.WARN_ADM_RECORD_MALFUNCTION
	/**
	 * 1031: Audio Device Module: The recorded audio volume is too low.
	 */
	WARN_ADM_RECORD_AUDIO_LOWLEVEL WARN_CODE_TYPE = C.WARN_ADM_RECORD_AUDIO_LOWLEVEL
	/**
	 * 1032: Audio Device Module: The playback audio volume is too low.
	 */
	WARN_ADM_PLAYOUT_AUDIO_LOWLEVEL WARN_CODE_TYPE = C.WARN_ADM_PLAYOUT_AUDIO_LOWLEVEL
	/**
	 ...
	 */
	WARN_ADM_WINDOWS_NO_DATA_READY_EVENT WARN_CODE_TYPE = C.WARN_ADM_WINDOWS_NO_DATA_READY_EVENT
	/**
	 * 1051: Audio Device Module: The SDK detects howling.
	 */
	WARN_APM_HOWLING WARN_CODE_TYPE = C.WARN_APM_HOWLING
	/**
	 * 1052: Audio Device Module: The audio device is in a glitching state.
	 */
	WARN_ADM_GLITCH_STATE WARN_CODE_TYPE = C.WARN_ADM_GLITCH_STATE
	/**
	 * 1053: Audio Device Module: The settings are improper.
	 */
	WARN_ADM_IMPROPER_SETTINGS WARN_CODE_TYPE = C.WARN_ADM_IMPROPER_SETTINGS
	/**
	 * 1322: No recording device.
	 */
	WARN_ADM_WIN_CORE_NO_RECORDING_DEVICE WARN_CODE_TYPE = C.WARN_ADM_WIN_CORE_NO_RECORDING_DEVICE
	/**
	 * 1323: Audio device module: No available playback device.
	 * You can try plugging in the audio device.
	 */
	WARN_ADM_WIN_CORE_NO_PLAYOUT_DEVICE WARN_CODE_TYPE = C.WARN_ADM_WIN_CORE_NO_PLAYOUT_DEVICE
	/**
	 ...
	 * - Update the sound card drive.
	 */
	WARN_ADM_WIN_CORE_IMPROPER_CAPTURE_RELEASE WARN_CODE_TYPE = C.WARN_ADM_WIN_CORE_IMPROPER_CAPTURE_RELEASE
)

/**
 * The error codes.
 */
type ERROR_CODE_TYPE C.enum_C_ERROR_CODE_TYPE

const (
	/**
	 * 0: No error occurs.
	 */
	ERR_OK ERROR_CODE_TYPE = C.ERR_OK
	// 1~1000
	/**
	 * 1: A general error occurs (no specified reason).
	 */
	ERR_FAILED ERROR_CODE_TYPE = C.ERR_FAILED
	/**
	 * 2: The argument is invalid. For example, the specific channel name
	 * includes illegal characters.
	 */
	ERR_INVALID_ARGUMENT ERROR_CODE_TYPE = C.ERR_INVALID_ARGUMENT
	/**
	 ...
	 */
	ERR_NOT_READY ERROR_CODE_TYPE = C.ERR_NOT_READY
	/**
	 * 4: The SDK does not support this function.
	 */
	ERR_NOT_SUPPORTED ERROR_CODE_TYPE = C.ERR_NOT_SUPPORTED
	/**
	 * 5: The request is rejected.
	 */
	ERR_REFUSED ERROR_CODE_TYPE = C.ERR_REFUSED
	/**
	 * 6: The buffer size is not big enough to store the returned data.
	 */
	ERR_BUFFER_TOO_SMALL ERROR_CODE_TYPE = C.ERR_BUFFER_TOO_SMALL
	/**
	 * 7: The SDK is not initialized before calling this method.
	 */
	ERR_NOT_INITIALIZED ERROR_CODE_TYPE = C.ERR_NOT_INITIALIZED
	/**
	 * 8: The state is invalid.
	 */
	ERR_INVALID_STATE ERROR_CODE_TYPE = C.ERR_INVALID_STATE
	/**
	 * 9: No permission. This is for internal use only, and does
	 * not return to the app through any method or callback.
	 */
	ERR_NO_PERMISSION ERROR_CODE_TYPE = C.ERR_NO_PERMISSION
	/**
	 ...
	 */
	ERR_JOIN_CHANNEL_REJECTED ERROR_CODE_TYPE = C.ERR_JOIN_CHANNEL_REJECTED
	/**
	 ...
	 * "leaveChannel".
	 */
	ERR_LEAVE_CHANNEL_REJECTED ERROR_CODE_TYPE = C.ERR_LEAVE_CHANNEL_REJECTED
	/**
	 * 19: The resources have been occupied and cannot be reused.
	 */
	ERR_ALREADY_IN_USE ERROR_CODE_TYPE = C.ERR_ALREADY_IN_USE
	/**
	 ...
	 */
	ERR_INVALID_APP_ID ERROR_CODE_TYPE = C.ERR_INVALID_APP_ID
	/**
	 * 102: The specified channel name is invalid. Please try to rejoin the
	 * channel with a valid channel name.
	 */
	ERR_INVALID_CHANNEL_NAME ERROR_CODE_TYPE = C.ERR_INVALID_CHANNEL_NAME
	/**
	 ...
	 *  "initialize".
	 */
	ERR_NO_SERVER_RESOURCES ERROR_CODE_TYPE = C.ERR_NO_SERVER_RESOURCES
	/**
	 ...
	 */
	ERR_TOKEN_EXPIRED ERROR_CODE_TYPE = C.ERR_TOKEN_EXPIRED
	/**
	 ...
	 */
	ERR_INVALID_TOKEN ERROR_CODE_TYPE = C.ERR_INVALID_TOKEN
	/**
	 * 111: The internet connection is interrupted. This applies to the Agora Web
	 * SDK only.
	 */
	ERR_CONNECTION_INTERRUPTED ERROR_CODE_TYPE = C.ERR_CONNECTION_INTERRUPTED // only used in web sdk
	/**
	 * 112: The internet connection is lost. This applies to the Agora Web SDK
	 * only.
	 */
	ERR_CONNECTION_LOST ERROR_CODE_TYPE = C.ERR_CONNECTION_LOST // only used in web sdk
	/**
	 * 113: The user is not in the channel when calling the
	 * \ref agora::rtc::IRtcEngine::sendStreamMessage "sendStreamMessage()" method.
	 */
	ERR_NOT_IN_CHANNEL ERROR_CODE_TYPE = C.ERR_NOT_IN_CHANNEL
	/**
	 * 114: The data size is over 1024 bytes when the user calls the
	 * \ref agora::rtc::IRtcEngine::sendStreamMessage "sendStreamMessage()" method.
	 */
	ERR_SIZE_TOO_LARGE ERROR_CODE_TYPE = C.ERR_SIZE_TOO_LARGE
	/**
	 ...
	 */
	ERR_BITRATE_LIMIT ERROR_CODE_TYPE = C.ERR_BITRATE_LIMIT
	/**
	 ...
	 */
	ERR_TOO_MANY_DATA_STREAMS ERROR_CODE_TYPE = C.ERR_TOO_MANY_DATA_STREAMS
	/**
	 * 117: A timeout occurs for the data stream transmission.
	 */
	ERR_STREAM_MESSAGE_TIMEOUT ERROR_CODE_TYPE = C.ERR_STREAM_MESSAGE_TIMEOUT
	/**
	 * 119: Switching the user role fails. Please try to rejoin the channel.
	 */
	ERR_SET_CLIENT_ROLE_NOT_AUTHORIZED ERROR_CODE_TYPE = C.ERR_SET_CLIENT_ROLE_NOT_AUTHORIZED
	/**
	 ...
	 */
	ERR_DECRYPTION_FAILED ERROR_CODE_TYPE = C.ERR_DECRYPTION_FAILED
	/**
	 * 121: The user ID is invalid.
	 */
	ERR_INVALID_USER_ID ERROR_CODE_TYPE = C.ERR_INVALID_USER_ID
	/**
	 ...
	 */
	ERR_DATASTREAM_DECRYPTION_FAILED ERROR_CODE_TYPE = C.ERR_DATASTREAM_DECRYPTION_FAILED
	/**
	 * 123: The app is banned by the server.
	 */
	ERR_CLIENT_IS_BANNED_BY_SERVER ERROR_CODE_TYPE = C.ERR_CLIENT_IS_BANNED_BY_SERVER
	/**
	 ...
	 */
	ERR_ENCRYPTED_STREAM_NOT_ALLOWED_PUBLISH ERROR_CODE_TYPE = C.ERR_ENCRYPTED_STREAM_NOT_ALLOWED_PUBLISH

	/**
	 * 131: License credential is invalid
	 */
	ERR_LICENSE_CREDENTIAL_INVALID ERROR_CODE_TYPE = C.ERR_LICENSE_CREDENTIAL_INVALID

	/**
	 * 134: The user account is invalid, usually because the data format of the user account is incorrect.
	 */
	ERR_INVALID_USER_ACCOUNT ERROR_CODE_TYPE = C.ERR_INVALID_USER_ACCOUNT
	 ...
	 *
	 */
	ERR_MODULE_NOT_FOUND ERROR_CODE_TYPE = C.ERR_MODULE_NOT_FOUND

	// Licensing, keep the license error code same as the main version
	ERR_CERT_RAW        ERROR_CODE_TYPE = C.ERR_CERT_RAW
	ERR_CERT_JSON_PART  ERROR_CODE_TYPE = C.ERR_CERT_JSON_PART
	ERR_CERT_JSON_INVAL ERROR_CODE_TYPE = C.ERR_CERT_JSON_INVAL
	ERR_CERT_JSON_NOMEM ERROR_CODE_TYPE = C.ERR_CERT_JSON_NOMEM
	ERR_CERT_CUSTOM     ERROR_CODE_TYPE = C.ERR_CERT_CUSTOM
	ERR_CERT_CREDENTIAL ERROR_CODE_TYPE = C.ERR_CERT_CREDENTIAL
	ERR_CERT_SIGN       ERROR_CODE_TYPE = C.ERR_CERT_SIGN
	ERR_CERT_FAIL       ERROR_CODE_TYPE = C.ERR_CERT_FAIL
	ERR_CERT_BUF        ERROR_CODE_TYPE = C.ERR_CERT_BUF
	ERR_CERT_NULL       ERROR_CODE_TYPE = C.ERR_CERT_NULL
	ERR_CERT_DUEDATE    ERROR_CODE_TYPE = C.ERR_CERT_DUEDATE
	ERR_CERT_REQUEST    ERROR_CODE_TYPE = C.ERR_CERT_REQUEST

	// PcmSend Error num
	ERR_PCMSEND_FORMAT         ERROR_CODE_TYPE = C.ERR_PCMSEND_FORMAT         // unsupport pcm format
	ERR_PCMSEND_BUFFEROVERFLOW ERROR_CODE_TYPE = C.ERR_PCMSEND_BUFFEROVERFLOW // buffer overflow, the pcm send rate too quickly

	/// @cond
	// signaling: 400~600
	ERR_LOGIN_ALREADY_LOGIN ERROR_CODE_TYPE = C.ERR_LOGIN_ALREADY_LOGIN
	 ...
	 */
	ERR_LOAD_MEDIA_ENGINE ERROR_CODE_TYPE = C.ERR_LOAD_MEDIA_ENGINE
	/**
	 ...
	 */
	ERR_ADM_GENERAL_ERROR ERROR_CODE_TYPE = C.ERR_ADM_GENERAL_ERROR
	/**
	 * 1008: Audio Device Module: An error occurs in initializing the playback
	 * device.
	 */
	ERR_ADM_INIT_PLAYOUT ERROR_CODE_TYPE = C.ERR_ADM_INIT_PLAYOUT
	/**
	 * 1009: Audio Device Module: An error occurs in starting the playback device.
	 */
	ERR_ADM_START_PLAYOUT ERROR_CODE_TYPE = C.ERR_ADM_START_PLAYOUT
	/**
	 * 1010: Audio Device Module: An error occurs in stopping the playback device.
	 */
	ERR_ADM_STOP_PLAYOUT ERROR_CODE_TYPE = C.ERR_ADM_STOP_PLAYOUT
	/**
	 * 1011: Audio Device Module: An error occurs in initializing the recording
	 * device.
	 */
	ERR_ADM_INIT_RECORDING ERROR_CODE_TYPE = C.ERR_ADM_INIT_RECORDING
	/**
	 * 1012: Audio Device Module: An error occurs in starting the recording device.
	 */
	ERR_ADM_START_RECORDING ERROR_CODE_TYPE = C.ERR_ADM_START_RECORDING
	/**
	 * 1013: Audio Device Module: An error occurs in stopping the recording device.
	 */
	ERR_ADM_STOP_RECORDING ERROR_CODE_TYPE = C.ERR_ADM_STOP_RECORDING
	/**
	 * 1501: Video Device Module: The camera is not authorized.
	 */
	ERR_VDM_CAMERA_NOT_AUTHORIZED ERROR_CODE_TYPE = C.ERR_VDM_CAMERA_NOT_AUTHORIZED
	/**
	 * 2007: Audio Device Module: An error occurs in starting the application loopback.
	 */
	ERR_ADM_APPLICATION_LOOPBACK ERROR_CODE_TYPE = C.ERR_ADM_APPLICATION_LOOPBACK
)

type LICENSE_ERROR_TYPE C.enum_C_LICENSE_ERROR_TYPE

const (
	/**
	 * 1: Invalid license
	 */
	LICENSE_ERR_INVALID LICENSE_ERROR_TYPE = C.LICENSE_ERR_INVALID
	/**
	 * 2: License expired
	 */
	LICENSE_ERR_EXPIRE LICENSE_ERROR_TYPE = C.LICENSE_ERR_EXPIRE
	/**
	 * 3: Exceed license minutes limit
	 */
	LICENSE_ERR_MINUTES_EXCEED LICENSE_ERROR_TYPE = C.LICENSE_ERR_MINUTES_EXCEED
	/**
	 * 4: License use in limited period
	 */
	LICENSE_ERR_LIMITED_PERIOD LICENSE_ERROR_TYPE = C.LICENSE_ERR_LIMITED_PERIOD
	/**
	 * 5: Same license used in different devices at the same time
	 */
	LICENSE_ERR_DIFF_DEVICES LICENSE_ERROR_TYPE = C.LICENSE_ERR_DIFF_DEVICES
	/**
	 * 99: SDK internal error
	 */
	LICENSE_ERR_INTERNAL LICENSE_ERROR_TYPE = C.LICENSE_ERR_INTERNAL
)

/**
 * The operational permission of the SDK on the audio session.
 */
type AUDIO_SESSION_OPERATION_RESTRICTION C.enum_C_AUDIO_SESSION_OPERATION_RESTRICTION

const (
	/**
	 * 0: No restriction; the SDK can change the audio session.
	 */
	AUDIO_SESSION_OPERATION_RESTRICTION_NONE AUDIO_SESSION_OPERATION_RESTRICTION = C.AUDIO_SESSION_OPERATION_RESTRICTION_NONE
	/**
	 * 1: The SDK cannot change the audio session category.
	 */
	AUDIO_SESSION_OPERATION_RESTRICTION_SET_CATEGORY AUDIO_SESSION_OPERATION_RESTRICTION = C.AUDIO_SESSION_OPERATION_RESTRICTION_SET_CATEGORY
	/**
	 * 2: The SDK cannot change the audio session category, mode, or categoryOptions.
	 */
	AUDIO_SESSION_OPERATION_RESTRICTION_CONFIGURE_SESSION AUDIO_SESSION_OPERATION_RESTRICTION = C.AUDIO_SESSION_OPERATION_RESTRICTION_CONFIGURE_SESSION
	/**
	 ...
	 */
	AUDIO_SESSION_OPERATION_RESTRICTION_DEACTIVATE_SESSION AUDIO_SESSION_OPERATION_RESTRICTION = C.AUDIO_SESSION_OPERATION_RESTRICTION_DEACTIVATE_SESSION
	/**
	 ...
	 */
	AUDIO_SESSION_OPERATION_RESTRICTION_ALL AUDIO_SESSION_OPERATION_RESTRICTION = C.AUDIO_SESSION_OPERATION_RESTRICTION_ALL
)
 ...
 */
type USER_OFFLINE_REASON_TYPE C.enum_C_USER_OFFLINE_REASON_TYPE

const (
	/**
	 * 0: The user leaves the current channel.
	 */
	USER_OFFLINE_QUIT USER_OFFLINE_REASON_TYPE = C.USER_OFFLINE_QUIT
	/**
	 ...
	 */
	USER_OFFLINE_DROPPED USER_OFFLINE_REASON_TYPE = C.USER_OFFLINE_DROPPED
	/**
	 * 2: The user switches the client role from the host to the audience.
	 */
	USER_OFFLINE_BECOME_AUDIENCE USER_OFFLINE_REASON_TYPE = C.USER_OFFLINE_BECOME_AUDIENCE
)

type INTERFACE_ID_TYPE C.enum_C_INTERFACE_ID_TYPE

const (
	AGORA_IID_AUDIO_DEVICE_MANAGER   INTERFACE_ID_TYPE = C.AGORA_IID_AUDIO_DEVICE_MANAGER
	AGORA_IID_VIDEO_DEVICE_MANAGER   INTERFACE_ID_TYPE = C.AGORA_IID_VIDEO_DEVICE_MANAGER
	AGORA_IID_PARAMETER_ENGINE       INTERFACE_ID_TYPE = C.AGORA_IID_PARAMETER_ENGINE
	AGORA_IID_MEDIA_ENGINE           INTERFACE_ID_TYPE = C.AGORA_IID_MEDIA_ENGINE
	AGORA_IID_AUDIO_ENGINE           INTERFACE_ID_TYPE = C.AGORA_IID_AUDIO_ENGINE
	AGORA_IID_VIDEO_ENGINE           INTERFACE_ID_TYPE = C.AGORA_IID_VIDEO_ENGINE
	AGORA_IID_RTC_CONNECTION         INTERFACE_ID_TYPE = C.AGORA_IID_RTC_CONNECTION
	AGORA_IID_SIGNALING_ENGINE       INTERFACE_ID_TYPE = C.AGORA_IID_SIGNALING_ENGINE
	AGORA_IID_MEDIA_ENGINE_REGULATOR INTERFACE_ID_TYPE = C.AGORA_IID_MEDIA_ENGINE_REGULATOR
	AGORA_IID_CLOUD_SPATIAL_AUDIO    INTERFACE_ID_TYPE = C.AGORA_IID_CLOUD_SPATIAL_AUDIO
	AGORA_IID_LOCAL_SPATIAL_AUDIO    INTERFACE_ID_TYPE = C.AGORA_IID_LOCAL_SPATIAL_AUDIO
	AGORA_IID_STATE_SYNC             INTERFACE_ID_TYPE = C.AGORA_IID_STATE_SYNC
	AGORA_IID_METACHAT_SERVICE       INTERFACE_ID_TYPE = C.AGORA_IID_METACHAT_SERVICE
	AGORA_IID_MUSIC_CONTENT_CENTER   INTERFACE_ID_TYPE = C.AGORA_IID_MUSIC_CONTENT_CENTER
	AGORA_IID_H265_TRANSCODER        INTERFACE_ID_TYPE = C.AGORA_IID_H265_TRANSCODER
)

/**
 * The network quality types.
 */
type QUALITY_TYPE C.enum_C_QUALITY_TYPE
...
const (
	 ...
	 */
	QUALITY_EXCELLENT QUALITY_TYPE = C.QUALITY_EXCELLENT
	/**
	 * 2: The quality is quite good, but the bitrate may be slightly
	 * lower than excellent.
	 */
	QUALITY_GOOD QUALITY_TYPE = C.QUALITY_GOOD
	/**
	 * 3: Users can feel the communication slightly impaired.
	 */
	QUALITY_POOR QUALITY_TYPE = C.QUALITY_POOR
	/**
	 * 4: Users cannot communicate smoothly.
	 */
	QUALITY_BAD QUALITY_TYPE = C.QUALITY_BAD
	/**
	 * 5: Users can barely communicate.
	 */
	QUALITY_VBAD QUALITY_TYPE = C.QUALITY_VBAD
	/**
	 * 6: Users cannot communicate at all.
	 */
	QUALITY_DOWN QUALITY_TYPE = C.QUALITY_DOWN
	/**
	 * 7: (For future use) The network quality cannot be detected.
	 */
	QUALITY_UNSUPPORTED QUALITY_TYPE = C.QUALITY_UNSUPPORTED
	/**
	 * 8: Detecting the network quality.
	 */
	QUALITY_DETECTING QUALITY_TYPE = C.QUALITY_DETECTING
)

/**
 * Content fit modes.
 */
type FIT_MODE_TYPE C.enum_C_FIT_MODE_TYPE
...
const (
	 ...
	 */
	MODE_COVER FIT_MODE_TYPE = C.MODE_COVER
	 ...
	 */
	MODE_CONTAIN FIT_MODE_TYPE = C.MODE_CONTAIN
)

/**
 * The rotation information.
 */
type VIDEO_ORIENTATION C.enum_C_VIDEO_ORIENTATION

const (
	/**
	 * 0: Rotate the video by 0 degree clockwise.
	 */
	VIDEO_ORIENTATION_0 VIDEO_ORIENTATION = C.VIDEO_ORIENTATION_0
	/**
	 * 90: Rotate the video by 90 degrees clockwise.
	 */
	VIDEO_ORIENTATION_90 VIDEO_ORIENTATION = C.VIDEO_ORIENTATION_90
	/**
	 * 180: Rotate the video by 180 degrees clockwise.
	 */
	VIDEO_ORIENTATION_180 VIDEO_ORIENTATION = C.VIDEO_ORIENTATION_180
	/**
	 * 270: Rotate the video by 270 degrees clockwise.
	 */
	VIDEO_ORIENTATION_270 VIDEO_ORIENTATION = C.VIDEO_ORIENTATION_270
)

/**
 * The video frame rate.
 */
type FRAME_RATE C.enum_C_FRAME_RATE

const (
	/**
	 * 1: 1 fps.
	 */
	FRAME_RATE_FPS_1 FRAME_RATE = C.FRAME_RATE_FPS_1
	/**
	 * 7: 7 fps.
	 */
	FRAME_RATE_FPS_7 FRAME_RATE = C.FRAME_RATE_FPS_7
	/**
	 * 10: 10 fps.
	 */
	FRAME_RATE_FPS_10 FRAME_RATE = C.FRAME_RATE_FPS_10
	/**
	 * 15: 15 fps.
	 */
	FRAME_RATE_FPS_15 FRAME_RATE = C.FRAME_RATE_FPS_15
	/**
	 * 24: 24 fps.
	 */
	FRAME_RATE_FPS_24 FRAME_RATE = C.FRAME_RATE_FPS_24
	/**
	 * 30: 30 fps.
	 */
	FRAME_RATE_FPS_30 FRAME_RATE = C.FRAME_RATE_FPS_30
	/**
	 * 60: 60 fps. Applies to Windows and macOS only.
	 */
	FRAME_RATE_FPS_60 FRAME_RATE = C.FRAME_RATE_FPS_60
)

type FRAME_WIDTH C.enum_C_FRAME_WIDTH

const (
	FRAME_WIDTH_960 FRAME_WIDTH = C.FRAME_WIDTH_960
)

type FRAME_HEIGHT C.enum_C_FRAME_HEIGHT

const (
	FRAME_HEIGHT_540 FRAME_HEIGHT = C.FRAME_HEIGHT_540
)

/**
 * Types of the video frame.
 */
type VIDEO_FRAME_TYPE C.enum_C_VIDEO_FRAME_TYPE

const (
	/** 0: A black frame. */
	VIDEO_FRAME_TYPE_BLANK_FRAME VIDEO_FRAME_TYPE = C.VIDEO_FRAME_TYPE_BLANK_FRAME
	/** 3: Key frame. */
	VIDEO_FRAME_TYPE_KEY_FRAME VIDEO_FRAME_TYPE = C.VIDEO_FRAME_TYPE_KEY_FRAME
	/** 4: Delta frame. */
	VIDEO_FRAME_TYPE_DELTA_FRAME VIDEO_FRAME_TYPE = C.VIDEO_FRAME_TYPE_DELTA_FRAME
	/** 5: The B frame.*/
	VIDEO_FRAME_TYPE_B_FRAME VIDEO_FRAME_TYPE = C.VIDEO_FRAME_TYPE_B_FRAME
	/** 6: A discarded frame. */
	VIDEO_FRAME_TYPE_DROPPABLE_FRAME VIDEO_FRAME_TYPE = C.VIDEO_FRAME_TYPE_DROPPABLE_FRAME
	/** Unknown frame. */
	VIDEO_FRAME_TYPE_UNKNOW VIDEO_FRAME_TYPE = C.VIDEO_FRAME_TYPE_UNKNOW
)

/**
 * Video output orientation modes.
 */
type ORIENTATION_MODE C.enum_C_ORIENTATION_MODE
...
const (
	 ...
	 */
	ORIENTATION_MODE_ADAPTIVE ORIENTATION_MODE = C.ORIENTATION_MODE_ADAPTIVE
	/**
	 ...
	 * CDN live streaming.
	 */
	ORIENTATION_MODE_FIXED_LANDSCAPE ORIENTATION_MODE = C.ORIENTATION_MODE_FIXED_LANDSCAPE
	/**
	 ...
	 * CDN live streaming.
	 */
	ORIENTATION_MODE_FIXED_PORTRAIT ORIENTATION_MODE = C.ORIENTATION_MODE_FIXED_PORTRAIT
)

/**
 * (For future use) Video degradation preferences under limited bandwidth.
 */
type DEGRADATION_PREFERENCE C.enum_C_DEGRADATION_PREFERENCE
...
const (
	 ...
	 */
	MAINTAIN_QUALITY DEGRADATION_PREFERENCE = C.MAINTAIN_QUALITY
	/**
	 ...
	 */
	MAINTAIN_FRAMERATE DEGRADATION_PREFERENCE = C.MAINTAIN_FRAMERATE
	/**
	 ...
	 * priority.
	 */
	MAINTAIN_BALANCED DEGRADATION_PREFERENCE = C.MAINTAIN_BALANCED
	/**
	 * 3: Degrade framerate in order to maintain resolution.
	 */
	MAINTAIN_RESOLUTION DEGRADATION_PREFERENCE = C.MAINTAIN_RESOLUTION
	/**
	 * 4: Disable VQC adjustion.
	 */
	DISABLED DEGRADATION_PREFERENCE = C.DISABLED
)
 ...
 */
type SCREEN_CAPTURE_FRAMERATE_CAPABILITY C.enum_C_SCREEN_CAPTURE_FRAMERATE_CAPABILITY

const (
	SCREEN_CAPTURE_FRAMERATE_CAPABILITY_15_FPS SCREEN_CAPTURE_FRAMERATE_CAPABILITY = C.SCREEN_CAPTURE_FRAMERATE_CAPABILITY_15_FPS
	SCREEN_CAPTURE_FRAMERATE_CAPABILITY_30_FPS SCREEN_CAPTURE_FRAMERATE_CAPABILITY = C.SCREEN_CAPTURE_FRAMERATE_CAPABILITY_30_FPS
	SCREEN_CAPTURE_FRAMERATE_CAPABILITY_60_FPS SCREEN_CAPTURE_FRAMERATE_CAPABILITY = C.SCREEN_CAPTURE_FRAMERATE_CAPABILITY_60_FPS
)

/**
 * Video codec capability levels.
 */
type VIDEO_CODEC_CAPABILITY_LEVEL C.enum_C_VIDEO_CODEC_CAPABILITY_LEVEL

const (
	/** No specified level */
	CODEC_CAPABILITY_LEVEL_UNSPECIFIED VIDEO_CODEC_CAPABILITY_LEVEL = C.CODEC_CAPABILITY_LEVEL_UNSPECIFIED
	/** Only provide basic support for the codec type */
	CODEC_CAPABILITY_LEVEL_BASIC_SUPPORT VIDEO_CODEC_CAPABILITY_LEVEL = C.CODEC_CAPABILITY_LEVEL_BASIC_SUPPORT
	/** Can process 1080p video at a rate of approximately 30 fps. */
	CODEC_CAPABILITY_LEVEL_1080P30FPS VIDEO_CODEC_CAPABILITY_LEVEL = C.CODEC_CAPABILITY_LEVEL_1080P30FPS
	/** Can process 1080p video at a rate of approximately 60 fps. */
	CODEC_CAPABILITY_LEVEL_1080P60FPS VIDEO_CODEC_CAPABILITY_LEVEL = C.CODEC_CAPABILITY_LEVEL_1080P60FPS
	/** Can process 4k video at a rate of approximately 30 fps. */
	CODEC_CAPABILITY_LEVEL_4K60FPS VIDEO_CODEC_CAPABILITY_LEVEL = C.CODEC_CAPABILITY_LEVEL_4K60FPS
)

/**
 * The video codec types.
 */
type VIDEO_CODEC_TYPE C.enum_C_VIDEO_CODEC_TYPE

const (
	VIDEO_CODEC_NONE VIDEO_CODEC_TYPE = C.VIDEO_CODEC_NONE
	/**
	 * 1: Standard VP8.
	 */
	VIDEO_CODEC_VP8 VIDEO_CODEC_TYPE = C.VIDEO_CODEC_VP8
	/**
	 * 2: Standard H.264.
	 */
	VIDEO_CODEC_H264 VIDEO_CODEC_TYPE = C.VIDEO_CODEC_H264
	/**
	 * 3: Standard H.265.
	 */
	VIDEO_CODEC_H265 VIDEO_CODEC_TYPE = C.VIDEO_CODEC_H265
	/**
	 ...
	 */
	VIDEO_CODEC_GENERIC VIDEO_CODEC_TYPE = C.VIDEO_CODEC_GENERIC
	/**
	 * 7: Generic H264.
	 */
	VIDEO_CODEC_GENERIC_H264 VIDEO_CODEC_TYPE = C.VIDEO_CODEC_GENERIC_H264
	/**
	 * 12: AV1.
	 */
	VIDEO_CODEC_AV1 VIDEO_CODEC_TYPE = C.VIDEO_CODEC_AV1
	/**
	 * 5: VP9.
	 */
	VIDEO_CODEC_VP9 VIDEO_CODEC_TYPE = C.VIDEO_CODEC_VP9
	/**
	 * 20: Generic JPEG. This type consumes minimum computing resources and applies to IoT devices.
	 */
	VIDEO_CODEC_GENERIC_JPEG VIDEO_CODEC_TYPE = C.VIDEO_CODEC_GENERIC_JPEG
)

/**
 * The CC (Congestion Control) mode options.
 */
type TCcMode C.enum_C_TCcMode

const (
	/**
	 * Enable CC mode.
	 */
	CC_ENABLED TCcMode = C.CC_ENABLED
	/**
	 * Disable CC mode.
	 */
	CC_DISABLED TCcMode = C.CC_DISABLED
)
 ...
 * Audio codec types.
 */
type AUDIO_CODEC_TYPE C.enum_C_AUDIO_CODEC_TYPE

const (
	/**
	 * 1: OPUS.
	 */
	AUDIO_CODEC_OPUS AUDIO_CODEC_TYPE = C.AUDIO_CODEC_OPUS
	// kIsac = 2,
	/**
	 * 3: PCMA.
	 */
	AUDIO_CODEC_PCMA AUDIO_CODEC_TYPE = C.AUDIO_CODEC_PCMA
	/**
	 * 4: PCMU.
	 */
	AUDIO_CODEC_PCMU AUDIO_CODEC_TYPE = C.AUDIO_CODEC_PCMU
	/**
	 * 5: G722.
	 */
	AUDIO_CODEC_G722 AUDIO_CODEC_TYPE = C.AUDIO_CODEC_G722
	// kIlbc = 6,
	/** 7: AAC. */
	// AUDIO_CODEC_AAC = 7,
	/**
	 * 8: AAC LC.
	 */
	AUDIO_CODEC_AACLC AUDIO_CODEC_TYPE = C.AUDIO_CODEC_AACLC
	/**
	 * 9: HE AAC.
	 */
	AUDIO_CODEC_HEAAC AUDIO_CODEC_TYPE = C.AUDIO_CODEC_HEAAC
	/**
	 * 10: JC1.
	 */
	AUDIO_CODEC_JC1 AUDIO_CODEC_TYPE = C.AUDIO_CODEC_JC1
	/**
	 * 11: HE-AAC v2.
	 */
	AUDIO_CODEC_HEAAC2 AUDIO_CODEC_TYPE = C.AUDIO_CODEC_HEAAC2
	/**
	 * 12: LPCNET.
	 */
	AUDIO_CODEC_LPCNET AUDIO_CODEC_TYPE = C.AUDIO_CODEC_LPCNET
	/**
	 * 13: Opus codec, supporting 4-channel audio.
	 */
	AUDIO_CODEC_OPUS4C AUDIO_CODEC_TYPE = C.AUDIO_CODEC_OPUS4C
	/**
	 * 14: Opus codec, supporting 6-channel audio.
	 */
	AUDIO_CODEC_OPUS6C AUDIO_CODEC_TYPE = C.AUDIO_CODEC_OPUS6C
	/**
	 * 15: Opus codec, supporting 8-channel audio.
	 */
	AUDIO_CODEC_OPUS8C AUDIO_CODEC_TYPE = C.AUDIO_CODEC_OPUS8C
)

/**
 * Audio encoding types of the audio encoded frame observer.
 */
type AUDIO_ENCODING_TYPE C.enum_C_AUDIO_ENCODING_TYPE
...
const (
	 ...
	 */
	AUDIO_ENCODING_TYPE_AAC_16000_LOW AUDIO_ENCODING_TYPE = C.AUDIO_ENCODING_TYPE_AAC_16000_LOW
	/**
	 ...
	 */
	AUDIO_ENCODING_TYPE_AAC_16000_MEDIUM AUDIO_ENCODING_TYPE = C.AUDIO_ENCODING_TYPE_AAC_16000_MEDIUM
	/**
	 * AAC encoding format, 32000 Hz sampling rate, bass quality. A file with an audio duration of 10
	 * minutes is approximately 1.2 MB after encoding.
	 */
	AUDIO_ENCODING_TYPE_AAC_32000_LOW AUDIO_ENCODING_TYPE = C.AUDIO_ENCODING_TYPE_AAC_32000_LOW
	/**
	 * AAC encoding format, 32000 Hz sampling rate, medium sound quality. A file with an audio duration
	 * of 10 minutes is approximately 2 MB after encoding.
	 */
	AUDIO_ENCODING_TYPE_AAC_32000_MEDIUM AUDIO_ENCODING_TYPE = C.AUDIO_ENCODING_TYPE_AAC_32000_MEDIUM
	/**
	 ...
	 */
	AUDIO_ENCODING_TYPE_AAC_32000_HIGH AUDIO_ENCODING_TYPE = C.AUDIO_ENCODING_TYPE_AAC_32000_HIGH
	/**
	 * AAC encoding format, 48000 Hz sampling rate, medium sound quality. A file with an audio duration
	 * of 10 minutes is approximately 2 MB after encoding.
	 */
	AUDIO_ENCODING_TYPE_AAC_48000_MEDIUM AUDIO_ENCODING_TYPE = C.AUDIO_ENCODING_TYPE_AAC_48000_MEDIUM
	/**
	 ...
	 */
	AUDIO_ENCODING_TYPE_AAC_48000_HIGH AUDIO_ENCODING_TYPE = C.AUDIO_ENCODING_TYPE_AAC_48000_HIGH
	/**
	 ...
	 */
	AUDIO_ENCODING_TYPE_OPUS_16000_LOW AUDIO_ENCODING_TYPE = C.AUDIO_ENCODING_TYPE_OPUS_16000_LOW
	/**
	 * OPUS encoding format, 16000 Hz sampling rate, medium sound quality. A file with an audio duration
	 * of 10 minutes is approximately 2 MB after encoding.
	 */
	AUDIO_ENCODING_TYPE_OPUS_16000_MEDIUM AUDIO_ENCODING_TYPE = C.AUDIO_ENCODING_TYPE_OPUS_16000_MEDIUM
	/**
	 * OPUS encoding format, 48000 Hz sampling rate, medium sound quality. A file with an audio duration
	 * of 10 minutes is approximately 2 MB after encoding.
	 */
	AUDIO_ENCODING_TYPE_OPUS_48000_MEDIUM AUDIO_ENCODING_TYPE = C.AUDIO_ENCODING_TYPE_OPUS_48000_MEDIUM
	/**
	 * OPUS encoding format, 48000 Hz sampling rate, high sound quality. A file with an audio duration of
	 * 10 minutes is approximately 3.5 MB after encoding.
	 */
	AUDIO_ENCODING_TYPE_OPUS_48000_HIGH AUDIO_ENCODING_TYPE = C.AUDIO_ENCODING_TYPE_OPUS_48000_HIGH
)

/**
 * The adaptation mode of the watermark.
 */
type WATERMARK_FIT_MODE C.enum_C_WATERMARK_FIT_MODE
...
const (
	 ...
	 */
	FIT_MODE_COVER_POSITION WATERMARK_FIT_MODE = C.FIT_MODE_COVER_POSITION
	/**
	 ...
	 */
	FIT_MODE_USE_IMAGE_RATIO WATERMARK_FIT_MODE = C.FIT_MODE_USE_IMAGE_RATIO
)
 ...
 */
type H264PacketizeMode C.enum_C_H264PacketizeMode

const (
	/**
	 * Non-interleaved mode. See RFC 6184.
	 */
	NonInterleaved H264PacketizeMode = C.NonInterleaved // Mode 1 - STAP-A, FU-A is allowed
	/**
	 * Single NAL unit mode. See RFC 6184.
	 */
	SingleNalUnit H264PacketizeMode = C.SingleNalUnit // Mode 0 - only single NALU allowed
)

/**
 * Video stream types.
 */
type VIDEO_STREAM_TYPE C.enum_C_VIDEO_STREAM_TYPE

const (
	/**
	 * 0: The high-quality video stream, which has a higher resolution and bitrate.
	 */
	VIDEO_STREAM_HIGH VIDEO_STREAM_TYPE = C.VIDEO_STREAM_HIGH
	/**
	 * 1: The low-quality video stream, which has a lower resolution and bitrate.
	 */
	VIDEO_STREAM_LOW VIDEO_STREAM_TYPE = C.VIDEO_STREAM_LOW
)

type VideoSubscriptionOptions C.struct_C_VideoSubscriptionOptions
...
func NewVideoSubscriptionOptions() *VideoSubscriptionOptions {
	return (*VideoSubscriptionOptions)(C.C_VideoSubscriptionOptions_New())
}
func (this_ *VideoSubscriptionOptions) Delete() {
	C.C_VideoSubscriptionOptions_Delete((*C.struct_C_VideoSubscriptionOptions)(this_))
}
 ...
 */
type COMPRESSION_PREFERENCE C.enum_C_COMPRESSION_PREFERENCE

const (
	/**
	 * (Default) Low latency is preferred, usually used in real-time communication where low latency is the number one priority.
	 */
	PREFER_LOW_LATENCY COMPRESSION_PREFERENCE = C.PREFER_LOW_LATENCY
	/**
	 * Prefer quality in sacrifice of a degree of latency, usually around 30ms ~ 150ms, depends target fps
	 */
	PREFER_QUALITY COMPRESSION_PREFERENCE = C.PREFER_QUALITY
)

/**
 * The video encoder type preference.
 */
type ENCODING_PREFERENCE C.enum_C_ENCODING_PREFERENCE

const (
	/**
	 *Default .
	 */
	PREFER_AUTO ENCODING_PREFERENCE = C.PREFER_AUTO
	/**
	 *  Software encoding.
	 */
	PREFER_SOFTWARE ENCODING_PREFERENCE = C.PREFER_SOFTWARE
	/**
	 * Hardware encoding
	 */
	PREFER_HARDWARE ENCODING_PREFERENCE = C.PREFER_HARDWARE
)
 ...
 */
type VIDEO_MIRROR_MODE_TYPE C.enum_C_VIDEO_MIRROR_MODE_TYPE

const (
	/**
	 * 0: The mirror mode determined by the SDK.
	 */
	VIDEO_MIRROR_MODE_AUTO VIDEO_MIRROR_MODE_TYPE = C.VIDEO_MIRROR_MODE_AUTO
	/**
	 * 1: Enable the mirror mode.
	 */
	VIDEO_MIRROR_MODE_ENABLED VIDEO_MIRROR_MODE_TYPE = C.VIDEO_MIRROR_MODE_ENABLED
	/**
	 * 2: Disable the mirror mode.
	 */
	VIDEO_MIRROR_MODE_DISABLED VIDEO_MIRROR_MODE_TYPE = C.VIDEO_MIRROR_MODE_DISABLED
)

/** Supported codec type bit mask. */
type CODEC_CAP_MASK C.enum_C_CODEC_CAP_MASK

const (
	/** 0: No codec support. */
	CODEC_CAP_MASK_NONE CODEC_CAP_MASK = C.CODEC_CAP_MASK_NONE

	/** bit 1: Hardware decoder support flag. */
	CODEC_CAP_MASK_HW_DEC CODEC_CAP_MASK = C.CODEC_CAP_MASK_HW_DEC

	/** bit 2: Hardware encoder support flag. */
	CODEC_CAP_MASK_HW_ENC CODEC_CAP_MASK = C.CODEC_CAP_MASK_HW_ENC

	/** bit 3: Software decoder support flag. */
	CODEC_CAP_MASK_SW_DEC CODEC_CAP_MASK = C.CODEC_CAP_MASK_SW_DEC

	/** bit 4: Software encoder support flag. */
	CODEC_CAP_MASK_SW_ENC CODEC_CAP_MASK = C.CODEC_CAP_MASK_SW_ENC
)
 ...
 */
type SIMULCAST_STREAM_MODE C.enum_C_SIMULCAST_STREAM_MODE

const (
	/*
	 * disable simulcast stream until receive request for enable simulcast stream by other broadcaster
	 */
	AUTO_SIMULCAST_STREAM SIMULCAST_STREAM_MODE = C.AUTO_SIMULCAST_STREAM
	/*
	 * disable simulcast stream
	 */
	DISABLE_SIMULCAST_STREAM SIMULCAST_STREAM_MODE = C.DISABLE_SIMULCAST_STREAM
	/*
	 * always enable simulcast stream
	 */
	ENABLE_SIMULCAST_STREAM SIMULCAST_STREAM_MODE = C.ENABLE_SIMULCAST_STREAM
)
 ...
 */
type RtcStats C.struct_C_RtcStats
 ...
 * User role types.
 */
type CLIENT_ROLE_TYPE C.enum_C_CLIENT_ROLE_TYPE

const (
	/**
	 * 1: Broadcaster. A broadcaster can both send and receive streams.
	 */
	CLIENT_ROLE_BROADCASTER CLIENT_ROLE_TYPE = C.CLIENT_ROLE_BROADCASTER
	/**
	 * 2: Audience. An audience member can only receive streams.
	 */
	CLIENT_ROLE_AUDIENCE CLIENT_ROLE_TYPE = C.CLIENT_ROLE_AUDIENCE
)

/**
 * Quality change of the local video in terms of target frame rate and target bit rate since last count.
 */
type QUALITY_ADAPT_INDICATION C.enum_C_QUALITY_ADAPT_INDICATION

const (
	/**
	 * 0: The quality of the local video stays the same.
	 */
	ADAPT_NONE QUALITY_ADAPT_INDICATION = C.ADAPT_NONE
	/**
	 * 1: The quality improves because the network bandwidth increases.
	 */
	ADAPT_UP_BANDWIDTH QUALITY_ADAPT_INDICATION = C.ADAPT_UP_BANDWIDTH
	/**
	 * 2: The quality worsens because the network bandwidth decreases.
	 */
	ADAPT_DOWN_BANDWIDTH QUALITY_ADAPT_INDICATION = C.ADAPT_DOWN_BANDWIDTH
)
 ...
 */
type AUDIENCE_LATENCY_LEVEL_TYPE C.enum_C_AUDIENCE_LATENCY_LEVEL_TYPE

const (
	/**
	 * 1: Low latency.
	 */
	AUDIENCE_LATENCY_LEVEL_LOW_LATENCY AUDIENCE_LATENCY_LEVEL_TYPE = C.AUDIENCE_LATENCY_LEVEL_LOW_LATENCY
	/**
	 * 2: Ultra low latency.
	 */
	AUDIENCE_LATENCY_LEVEL_ULTRA_LOW_LATENCY AUDIENCE_LATENCY_LEVEL_TYPE = C.AUDIENCE_LATENCY_LEVEL_ULTRA_LOW_LATENCY
)

/**
 * The detailed options of a user.
 */
type ClientRoleOptions C.struct_C_ClientRoleOptions
 ...
 */
type EXPERIENCE_QUALITY_TYPE C.enum_C_EXPERIENCE_QUALITY_TYPE

const (
	/** 0: QoE of the local user is good.  */
	EXPERIENCE_QUALITY_GOOD EXPERIENCE_QUALITY_TYPE = C.EXPERIENCE_QUALITY_GOOD
	/** 1: QoE of the local user is poor.  */
	EXPERIENCE_QUALITY_BAD EXPERIENCE_QUALITY_TYPE = C.EXPERIENCE_QUALITY_BAD
)

/**
 * Reasons why the QoE of the local user when receiving a remote audio stream is poor.
 */
type EXPERIENCE_POOR_REASON C.enum_C_EXPERIENCE_POOR_REASON

const (
	/**
	 * 0: No reason, indicating good QoE of the local user.
	 */
	EXPERIENCE_REASON_NONE EXPERIENCE_POOR_REASON = C.EXPERIENCE_REASON_NONE
	/**
	 * 1: The remote user's network quality is poor.
	 */
	REMOTE_NETWORK_QUALITY_POOR EXPERIENCE_POOR_REASON = C.REMOTE_NETWORK_QUALITY_POOR
	/**
	 * 2: The local user's network quality is poor.
	 */
	LOCAL_NETWORK_QUALITY_POOR EXPERIENCE_POOR_REASON = C.LOCAL_NETWORK_QUALITY_POOR
	/**
	 * 4: The local user's Wi-Fi or mobile network signal is weak.
	 */
	WIRELESS_SIGNAL_POOR EXPERIENCE_POOR_REASON = C.WIRELESS_SIGNAL_POOR
	/**
	 ...
	 */
	WIFI_BLUETOOTH_COEXIST EXPERIENCE_POOR_REASON = C.WIFI_BLUETOOTH_COEXIST
)

/**
 * Audio AINS mode
 */
type AUDIO_AINS_MODE C.enum_C_AUDIO_AINS_MODE

const (
	/**
	 * AINS mode with soft suppression level.
	 */
	AINS_MODE_BALANCED AUDIO_AINS_MODE = C.AINS_MODE_BALANCED
	/**
	 * AINS mode with high suppression level.
	 */
	AINS_MODE_AGGRESSIVE AUDIO_AINS_MODE = C.AINS_MODE_AGGRESSIVE
	/**
	 * AINS mode with high suppression level and ultra-low-latency
	 */
	AINS_MODE_ULTRALOWLATENCY AUDIO_AINS_MODE = C.AINS_MODE_ULTRALOWLATENCY
)

/**
 * Audio profile types.
 */
type AUDIO_PROFILE_TYPE C.enum_C_AUDIO_PROFILE_TYPE
...
const (
	 ...
	 */
	AUDIO_PROFILE_DEFAULT AUDIO_PROFILE_TYPE = C.AUDIO_PROFILE_DEFAULT
	/**
	 * 1: A sample rate of 32 kHz, audio encoding, mono, and a bitrate of up to 18 Kbps.
	 */
	AUDIO_PROFILE_SPEECH_STANDARD AUDIO_PROFILE_TYPE = C.AUDIO_PROFILE_SPEECH_STANDARD
	/**
	 * 2: A sample rate of 48 kHz, music encoding, mono, and a bitrate of up to 64 Kbps.
	 */
	AUDIO_PROFILE_MUSIC_STANDARD AUDIO_PROFILE_TYPE = C.AUDIO_PROFILE_MUSIC_STANDARD
	/**
	 ...
	 */
	AUDIO_PROFILE_MUSIC_STANDARD_STEREO AUDIO_PROFILE_TYPE = C.AUDIO_PROFILE_MUSIC_STANDARD_STEREO
	/**
	 * 4: A sample rate of 48 kHz, music encoding, mono, and a bitrate of up to 96 Kbps.
	 */
	AUDIO_PROFILE_MUSIC_HIGH_QUALITY AUDIO_PROFILE_TYPE = C.AUDIO_PROFILE_MUSIC_HIGH_QUALITY
	/**
	 ...
	 * to `AUDIO_PROCESSING_STEREO` in `AdvancedAudioOptions`.
	 */
	AUDIO_PROFILE_MUSIC_HIGH_QUALITY_STEREO AUDIO_PROFILE_TYPE = C.AUDIO_PROFILE_MUSIC_HIGH_QUALITY_STEREO
	/**
	 * 6: A sample rate of 16 kHz, audio encoding, mono, and Acoustic Echo Cancellation (AES) enabled.
	 */
	AUDIO_PROFILE_IOT AUDIO_PROFILE_TYPE = C.AUDIO_PROFILE_IOT
	AUDIO_PROFILE_NUM AUDIO_PROFILE_TYPE = C.AUDIO_PROFILE_NUM
)

/**
 * The audio scenario.
 */
type AUDIO_SCENARIO_TYPE C.enum_C_AUDIO_SCENARIO_TYPE
...
const (
	 ...
	 */
	AUDIO_SCENARIO_DEFAULT AUDIO_SCENARIO_TYPE = C.AUDIO_SCENARIO_DEFAULT
	/**
	 ...
	 * music playback.
	 */
	AUDIO_SCENARIO_GAME_STREAMING AUDIO_SCENARIO_TYPE = C.AUDIO_SCENARIO_GAME_STREAMING
	/**
	 ...
	 */
	AUDIO_SCENARIO_CHATROOM AUDIO_SCENARIO_TYPE = C.AUDIO_SCENARIO_CHATROOM
	/**
	 * 7: Real-time chorus scenario, where users have good network conditions and require ultra-low latency.
	 */
	AUDIO_SCENARIO_CHORUS AUDIO_SCENARIO_TYPE = C.AUDIO_SCENARIO_CHORUS
	/**
	 * 8: Meeting
	 */
	AUDIO_SCENARIO_MEETING AUDIO_SCENARIO_TYPE = C.AUDIO_SCENARIO_MEETING
	/**
	 * 9: The number of enumerations.
	 */
	AUDIO_SCENARIO_NUM AUDIO_SCENARIO_TYPE = C.AUDIO_SCENARIO_NUM
)
 ...
 * Video content hints.
 */
type VIDEO_CONTENT_HINT C.enum_C_VIDEO_CONTENT_HINT

const (
	/**
	 * (Default) No content hint. In this case, the SDK balances smoothness with sharpness.
	 */
	CONTENT_HINT_NONE VIDEO_CONTENT_HINT = C.CONTENT_HINT_NONE
	/**
	 ...
	 *
	 */
	CONTENT_HINT_MOTION VIDEO_CONTENT_HINT = C.CONTENT_HINT_MOTION
	/**
	 ...
	 *
	 */
	CONTENT_HINT_DETAILS VIDEO_CONTENT_HINT = C.CONTENT_HINT_DETAILS
)

/**
 * The screen sharing scenario.
 */
type SCREEN_SCENARIO_TYPE C.enum_C_SCREEN_SCENARIO_TYPE
...
const (
	 ...
	 */
	SCREEN_SCENARIO_DOCUMENT SCREEN_SCENARIO_TYPE = C.SCREEN_SCENARIO_DOCUMENT
	/**
	 * 2: Game. This scenario prioritizes the smoothness of screen sharing. If you share games, you
	 * can set this scenario.
	 */
	SCREEN_SCENARIO_GAMING SCREEN_SCENARIO_TYPE = C.SCREEN_SCENARIO_GAMING
	/**
	 ...
	 */
	SCREEN_SCENARIO_VIDEO SCREEN_SCENARIO_TYPE = C.SCREEN_SCENARIO_VIDEO
	/**
	 ...
	 */
	SCREEN_SCENARIO_RDC SCREEN_SCENARIO_TYPE = C.SCREEN_SCENARIO_RDC
)

/**
 * The video application scenario type.
 */
type VIDEO_APPLICATION_SCENARIO_TYPE C.enum_C_VIDEO_APPLICATION_SCENARIO_TYPE

const (
	/**
	 * 0: Default Scenario.
	 */
	APPLICATION_SCENARIO_GENERAL VIDEO_APPLICATION_SCENARIO_TYPE = C.APPLICATION_SCENARIO_GENERAL
	/**
	 * 1: Meeting Scenario. This scenario is the best QoE practice of meeting application.
	 */
	APPLICATION_SCENARIO_MEETING VIDEO_APPLICATION_SCENARIO_TYPE = C.APPLICATION_SCENARIO_MEETING
)

/**
 * The brightness level of the video image captured by the local camera.
 */
type CAPTURE_BRIGHTNESS_LEVEL_TYPE C.enum_C_CAPTURE_BRIGHTNESS_LEVEL_TYPE
...
const (
	 ...
	 */
	CAPTURE_BRIGHTNESS_LEVEL_INVALID CAPTURE_BRIGHTNESS_LEVEL_TYPE = C.CAPTURE_BRIGHTNESS_LEVEL_INVALID
	/** 0: The brightness level of the video image is normal.
	 */
	CAPTURE_BRIGHTNESS_LEVEL_NORMAL CAPTURE_BRIGHTNESS_LEVEL_TYPE = C.CAPTURE_BRIGHTNESS_LEVEL_NORMAL
	/** 1: The brightness level of the video image is too bright.
	 */
	CAPTURE_BRIGHTNESS_LEVEL_BRIGHT CAPTURE_BRIGHTNESS_LEVEL_TYPE = C.CAPTURE_BRIGHTNESS_LEVEL_BRIGHT
	/** 2: The brightness level of the video image is too dark.
	 */
	CAPTURE_BRIGHTNESS_LEVEL_DARK CAPTURE_BRIGHTNESS_LEVEL_TYPE = C.CAPTURE_BRIGHTNESS_LEVEL_DARK
)

type CAMERA_STABILIZATION_MODE C.enum_C_CAMERA_STABILIZATION_MODE

const (
	/** The camera stabilization mode is disabled.
	 */
	CAMERA_STABILIZATION_MODE_OFF CAMERA_STABILIZATION_MODE = C.CAMERA_STABILIZATION_MODE_OFF
	/** device choose stabilization mode automatically.
	 */
	CAMERA_STABILIZATION_MODE_AUTO CAMERA_STABILIZATION_MODE = C.CAMERA_STABILIZATION_MODE_AUTO
	/** stabilization mode level 1.
	 */
	CAMERA_STABILIZATION_MODE_LEVEL_1 CAMERA_STABILIZATION_MODE = C.CAMERA_STABILIZATION_MODE_LEVEL_1
	/** stabilization mode level 2.
	 */
	CAMERA_STABILIZATION_MODE_LEVEL_2 CAMERA_STABILIZATION_MODE = C.CAMERA_STABILIZATION_MODE_LEVEL_2
	/** stabilization mode level 3.
	 */
	CAMERA_STABILIZATION_MODE_LEVEL_3 CAMERA_STABILIZATION_MODE = C.CAMERA_STABILIZATION_MODE_LEVEL_3
	/** The maximum level of the camera stabilization mode.
	 */
	CAMERA_STABILIZATION_MODE_MAX_LEVEL CAMERA_STABILIZATION_MODE = C.CAMERA_STABILIZATION_MODE_MAX_LEVEL
)

/**
 * Local audio statistics.
 */
type LOCAL_AUDIO_STREAM_STATE C.enum_C_LOCAL_AUDIO_STREAM_STATE

const (
	/**
	 * 0: The local audio is in the initial state.
	 */
	LOCAL_AUDIO_STREAM_STATE_STOPPED LOCAL_AUDIO_STREAM_STATE = C.LOCAL_AUDIO_STREAM_STATE_STOPPED
	/**
	 * 1: The capturing device starts successfully.
	 */
	LOCAL_AUDIO_STREAM_STATE_RECORDING LOCAL_AUDIO_STREAM_STATE = C.LOCAL_AUDIO_STREAM_STATE_RECORDING
	/**
	 * 2: The first audio frame encodes successfully.
	 */
	LOCAL_AUDIO_STREAM_STATE_ENCODING LOCAL_AUDIO_STREAM_STATE = C.LOCAL_AUDIO_STREAM_STATE_ENCODING
	/**
	 * 3: The local audio fails to start.
	 */
	LOCAL_AUDIO_STREAM_STATE_FAILED LOCAL_AUDIO_STREAM_STATE = C.LOCAL_AUDIO_STREAM_STATE_FAILED
)

/**
 * Local audio state error codes.
 */
type LOCAL_AUDIO_STREAM_ERROR C.enum_C_LOCAL_AUDIO_STREAM_ERROR

const (
	/**
	 * 0: The local audio is normal.
	 */
	LOCAL_AUDIO_STREAM_ERROR_OK LOCAL_AUDIO_STREAM_ERROR = C.LOCAL_AUDIO_STREAM_ERROR_OK
	/**
	 * 1: No specified reason for the local audio failure. Remind your users to try to rejoin the channel.
	 */
	LOCAL_AUDIO_STREAM_ERROR_FAILURE LOCAL_AUDIO_STREAM_ERROR = C.LOCAL_AUDIO_STREAM_ERROR_FAILURE
	/**
	 * 2: No permission to use the local audio device. Remind your users to grant permission.
	 */
	LOCAL_AUDIO_STREAM_ERROR_DEVICE_NO_PERMISSION LOCAL_AUDIO_STREAM_ERROR = C.LOCAL_AUDIO_STREAM_ERROR_DEVICE_NO_PERMISSION
	/**
	 ...
	 */
	LOCAL_AUDIO_STREAM_ERROR_DEVICE_BUSY LOCAL_AUDIO_STREAM_ERROR = C.LOCAL_AUDIO_STREAM_ERROR_DEVICE_BUSY
	/**
	 * 4: The local audio capture failed.
	 */
	LOCAL_AUDIO_STREAM_ERROR_RECORD_FAILURE LOCAL_AUDIO_STREAM_ERROR = C.LOCAL_AUDIO_STREAM_ERROR_RECORD_FAILURE
	/**
	 * 5: The local audio encoding failed.
	 */
	LOCAL_AUDIO_STREAM_ERROR_ENCODE_FAILURE LOCAL_AUDIO_STREAM_ERROR = C.LOCAL_AUDIO_STREAM_ERROR_ENCODE_FAILURE
	/** 6: The SDK cannot find the local audio recording device.
	 */
	LOCAL_AUDIO_STREAM_ERROR_NO_RECORDING_DEVICE LOCAL_AUDIO_STREAM_ERROR = C.LOCAL_AUDIO_STREAM_ERROR_NO_RECORDING_DEVICE
	/** 7: The SDK cannot find the local audio playback device.
	 */
	LOCAL_AUDIO_STREAM_ERROR_NO_PLAYOUT_DEVICE LOCAL_AUDIO_STREAM_ERROR = C.LOCAL_AUDIO_STREAM_ERROR_NO_PLAYOUT_DEVICE
	/**
	 * 8: The local audio capturing is interrupted by the system call.
	 */
	LOCAL_AUDIO_STREAM_ERROR_INTERRUPTED LOCAL_AUDIO_STREAM_ERROR = C.LOCAL_AUDIO_STREAM_ERROR_INTERRUPTED
	/** 9: An invalid audio capture device ID.
	 */
	LOCAL_AUDIO_STREAM_ERROR_RECORD_INVALID_ID LOCAL_AUDIO_STREAM_ERROR = C.LOCAL_AUDIO_STREAM_ERROR_RECORD_INVALID_ID
	/** 10: An invalid audio playback device ID.
	 */
	LOCAL_AUDIO_STREAM_ERROR_PLAYOUT_INVALID_ID LOCAL_AUDIO_STREAM_ERROR = C.LOCAL_AUDIO_STREAM_ERROR_PLAYOUT_INVALID_ID
)

/** Local video state types.
 */
type LOCAL_VIDEO_STREAM_STATE C.enum_C_LOCAL_VIDEO_STREAM_STATE

const (
	/**
	 * 0: The local video is in the initial state.
	 */
	LOCAL_VIDEO_STREAM_STATE_STOPPED LOCAL_VIDEO_STREAM_STATE = C.LOCAL_VIDEO_STREAM_STATE_STOPPED
	/**
	 ...
	 */
	LOCAL_VIDEO_STREAM_STATE_CAPTURING LOCAL_VIDEO_STREAM_STATE = C.LOCAL_VIDEO_STREAM_STATE_CAPTURING
	/**
	 * 2: The first video frame is successfully encoded.
	 */
	LOCAL_VIDEO_STREAM_STATE_ENCODING LOCAL_VIDEO_STREAM_STATE = C.LOCAL_VIDEO_STREAM_STATE_ENCODING
	/**
	 * 3: Fails to start the local video.
	 */
	LOCAL_VIDEO_STREAM_STATE_FAILED LOCAL_VIDEO_STREAM_STATE = C.LOCAL_VIDEO_STREAM_STATE_FAILED
)

/**
 * Local video state error codes.
 */
type LOCAL_VIDEO_STREAM_ERROR C.enum_C_LOCAL_VIDEO_STREAM_ERROR

const (
	/**
	 * 0: The local video is normal.
	 */
	LOCAL_VIDEO_STREAM_ERROR_OK LOCAL_VIDEO_STREAM_ERROR = C.LOCAL_VIDEO_STREAM_ERROR_OK
	/**
	 * 1: No specified reason for the local video failure.
	 */
	LOCAL_VIDEO_STREAM_ERROR_FAILURE LOCAL_VIDEO_STREAM_ERROR = C.LOCAL_VIDEO_STREAM_ERROR_FAILURE
	/**
	 * 2: No permission to use the local video capturing device. Remind the user to grant permission
	 * and rejoin the channel.
	 */
	LOCAL_VIDEO_STREAM_ERROR_DEVICE_NO_PERMISSION LOCAL_VIDEO_STREAM_ERROR = C.LOCAL_VIDEO_STREAM_ERROR_DEVICE_NO_PERMISSION
	/**
	 * 3: The local video capturing device is in use. Remind the user to check whether another
	 * application occupies the camera.
	 */
	LOCAL_VIDEO_STREAM_ERROR_DEVICE_BUSY LOCAL_VIDEO_STREAM_ERROR = C.LOCAL_VIDEO_STREAM_ERROR_DEVICE_BUSY
	/**
	 ...
	 * channel.
	 */
	LOCAL_VIDEO_STREAM_ERROR_CAPTURE_FAILURE LOCAL_VIDEO_STREAM_ERROR = C.LOCAL_VIDEO_STREAM_ERROR_CAPTURE_FAILURE
	/**
	 * 5: The local video encoder is not supported.
	 */
	LOCAL_VIDEO_STREAM_ERROR_ENCODE_FAILURE LOCAL_VIDEO_STREAM_ERROR = C.LOCAL_VIDEO_STREAM_ERROR_ENCODE_FAILURE
	/**
	 ...
	 */
	LOCAL_VIDEO_STREAM_ERROR_CAPTURE_INBACKGROUND LOCAL_VIDEO_STREAM_ERROR = C.LOCAL_VIDEO_STREAM_ERROR_CAPTURE_INBACKGROUND
	/**
	 ...
	 */
	LOCAL_VIDEO_STREAM_ERROR_CAPTURE_MULTIPLE_FOREGROUND_APPS LOCAL_VIDEO_STREAM_ERROR = C.LOCAL_VIDEO_STREAM_ERROR_CAPTURE_MULTIPLE_FOREGROUND_APPS
	/**
	 ...
	 * channel.
	 */
	LOCAL_VIDEO_STREAM_ERROR_DEVICE_NOT_FOUND LOCAL_VIDEO_STREAM_ERROR = C.LOCAL_VIDEO_STREAM_ERROR_DEVICE_NOT_FOUND
	/**
	 *  9: (macOS only) The video capture device currently in use is disconnected (such as being
	 * unplugged).
	 */
	LOCAL_VIDEO_STREAM_ERROR_DEVICE_DISCONNECTED LOCAL_VIDEO_STREAM_ERROR = C.LOCAL_VIDEO_STREAM_ERROR_DEVICE_DISCONNECTED
	/**
	 ...
	 */
	LOCAL_VIDEO_STREAM_ERROR_DEVICE_INVALID_ID LOCAL_VIDEO_STREAM_ERROR = C.LOCAL_VIDEO_STREAM_ERROR_DEVICE_INVALID_ID
	/**
	 ...
	 */
	LOCAL_VIDEO_STREAM_ERROR_DEVICE_INTERRUPT LOCAL_VIDEO_STREAM_ERROR = C.LOCAL_VIDEO_STREAM_ERROR_DEVICE_INTERRUPT
	/**
	 ...
	 */
	LOCAL_VIDEO_STREAM_ERROR_DEVICE_FATAL_ERROR LOCAL_VIDEO_STREAM_ERROR = C.LOCAL_VIDEO_STREAM_ERROR_DEVICE_FATAL_ERROR
	/**
	 * 101: The current video capture device is unavailable due to excessive system pressure.
	 */
	LOCAL_VIDEO_STREAM_ERROR_DEVICE_SYSTEM_PRESSURE LOCAL_VIDEO_STREAM_ERROR = C.LOCAL_VIDEO_STREAM_ERROR_DEVICE_SYSTEM_PRESSURE
	/**
	 ...
	 */
	LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_WINDOW_MINIMIZED LOCAL_VIDEO_STREAM_ERROR = C.LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_WINDOW_MINIMIZED
	/**
	 ...
	 */
	LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_WINDOW_CLOSED LOCAL_VIDEO_STREAM_ERROR = C.LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_WINDOW_CLOSED
	/** 13: The local screen capture window is occluded. */
	LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_WINDOW_OCCLUDED LOCAL_VIDEO_STREAM_ERROR = C.LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_WINDOW_OCCLUDED
	/** 20: The local screen capture window is not supported. */
	LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_WINDOW_NOT_SUPPORTED LOCAL_VIDEO_STREAM_ERROR = C.LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_WINDOW_NOT_SUPPORTED
	/** 21: The screen capture fails. */
	LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_FAILURE LOCAL_VIDEO_STREAM_ERROR = C.LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_FAILURE
	/** 22: No permision to capture screen. */
	LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_NO_PERMISSION LOCAL_VIDEO_STREAM_ERROR = C.LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_NO_PERMISSION
	/**
	 ...
	 */
	LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_PAUSED LOCAL_VIDEO_STREAM_ERROR = C.LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_PAUSED
	/** 24: The screen capture is resumed. */
	LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_RESUMED LOCAL_VIDEO_STREAM_ERROR = C.LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_RESUMED
	/** 25: (Windows only) The local screen capture window is currently hidden and not visible on the desktop. */
	LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_WINDOW_HIDDEN LOCAL_VIDEO_STREAM_ERROR = C.LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_WINDOW_HIDDEN
	/** 26: (Windows only) The local screen capture window is recovered from its hidden state. */
	LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_WINDOW_RECOVER_FROM_HIDDEN LOCAL_VIDEO_STREAM_ERROR = C.LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_WINDOW_RECOVER_FROM_HIDDEN
	/** 27:(Windows only) The window is recovered from miniminzed */
	LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_WINDOW_RECOVER_FROM_MINIMIZED LOCAL_VIDEO_STREAM_ERROR = C.LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_WINDOW_RECOVER_FROM_MINIMIZED
)

/**
 * Remote audio states.
 */
type REMOTE_AUDIO_STATE C.enum_C_REMOTE_AUDIO_STATE
...
const (
	 ...
	 */
	REMOTE_AUDIO_STATE_STOPPED REMOTE_AUDIO_STATE = C.REMOTE_AUDIO_STATE_STOPPED // Default state, audio is started or remote user disabled/muted audio stream
	/**
	 * 1: The first remote audio packet is received.
	 */
	REMOTE_AUDIO_STATE_STARTING REMOTE_AUDIO_STATE = C.REMOTE_AUDIO_STATE_STARTING // The first audio frame packet has been received
	/**
	 ...
	 */
	REMOTE_AUDIO_STATE_DECODING REMOTE_AUDIO_STATE = C.REMOTE_AUDIO_STATE_DECODING // The first remote audio frame has been decoded or fronzen state ends
	/**
	 * 3: The remote audio is frozen. The SDK reports this state in the case of
	 * `REMOTE_AUDIO_REASON_NETWORK_CONGESTION(1)`.
	 */
	REMOTE_AUDIO_STATE_FROZEN REMOTE_AUDIO_STATE = C.REMOTE_AUDIO_STATE_FROZEN // Remote audio is frozen, probably due to network issue
	/**
	 * 4: The remote audio fails to start. The SDK reports this state in the case of
	 * `REMOTE_AUDIO_REASON_INTERNAL(0)`.
	 */
	REMOTE_AUDIO_STATE_FAILED REMOTE_AUDIO_STATE = C.REMOTE_AUDIO_STATE_FAILED // Remote audio play failed
)

/**
 * Reasons for the remote audio state change.
 */
type REMOTE_AUDIO_STATE_REASON C.enum_C_REMOTE_AUDIO_STATE_REASON

const (
	/**
	 * 0: The SDK reports this reason when the video state changes.
	 */
	REMOTE_AUDIO_REASON_INTERNAL REMOTE_AUDIO_STATE_REASON = C.REMOTE_AUDIO_REASON_INTERNAL
	/**
	 * 1: Network congestion.
	 */
	REMOTE_AUDIO_REASON_NETWORK_CONGESTION REMOTE_AUDIO_STATE_REASON = C.REMOTE_AUDIO_REASON_NETWORK_CONGESTION
	/**
	 * 2: Network recovery.
	 */
	REMOTE_AUDIO_REASON_NETWORK_RECOVERY REMOTE_AUDIO_STATE_REASON = C.REMOTE_AUDIO_REASON_NETWORK_RECOVERY
	/**
	 * 3: The local user stops receiving the remote audio stream or
	 * disables the audio module.
	 */
	REMOTE_AUDIO_REASON_LOCAL_MUTED REMOTE_AUDIO_STATE_REASON = C.REMOTE_AUDIO_REASON_LOCAL_MUTED
	/**
	 * 4: The local user resumes receiving the remote audio stream or
	 * enables the audio module.
	 */
	REMOTE_AUDIO_REASON_LOCAL_UNMUTED REMOTE_AUDIO_STATE_REASON = C.REMOTE_AUDIO_REASON_LOCAL_UNMUTED
	/**
	 * 5: The remote user stops sending the audio stream or disables the
	 * audio module.
	 */
	REMOTE_AUDIO_REASON_REMOTE_MUTED REMOTE_AUDIO_STATE_REASON = C.REMOTE_AUDIO_REASON_REMOTE_MUTED
	/**
	 * 6: The remote user resumes sending the audio stream or enables the
	 * audio module.
	 */
	REMOTE_AUDIO_REASON_REMOTE_UNMUTED REMOTE_AUDIO_STATE_REASON = C.REMOTE_AUDIO_REASON_REMOTE_UNMUTED
	/**
	 * 7: The remote user leaves the channel.
	 */
	REMOTE_AUDIO_REASON_REMOTE_OFFLINE REMOTE_AUDIO_STATE_REASON = C.REMOTE_AUDIO_REASON_REMOTE_OFFLINE
	/**
	 * 8: Not receive any audio packet from remote user.
	 */
	REMOTE_AUDIO_REASON_REMOTE_NO_PACKET_RECEIVE REMOTE_AUDIO_STATE_REASON = C.REMOTE_AUDIO_REASON_REMOTE_NO_PACKET_RECEIVE
	/**
	 * 8: Not receive any audio packet from remote user.
	 */
	REMOTE_AUDIO_REASON_REMOTE_LOCAL_PLAY_FAILED REMOTE_AUDIO_STATE_REASON = C.REMOTE_AUDIO_REASON_REMOTE_LOCAL_PLAY_FAILED
)

/**
 * The state of the remote video.
 */
type REMOTE_VIDEO_STATE C.enum_C_REMOTE_VIDEO_STATE
...
const (
	 ...
	 */
	REMOTE_VIDEO_STATE_STOPPED REMOTE_VIDEO_STATE = C.REMOTE_VIDEO_STATE_STOPPED
	/**
	 * 1: The first remote video packet is received.
	 */
	REMOTE_VIDEO_STATE_STARTING REMOTE_VIDEO_STATE = C.REMOTE_VIDEO_STATE_STARTING
	/**
	 ...
	 */
	REMOTE_VIDEO_STATE_DECODING REMOTE_VIDEO_STATE = C.REMOTE_VIDEO_STATE_DECODING
	/** 3: The remote video is frozen, probably due to
	 * #REMOTE_VIDEO_STATE_REASON_NETWORK_CONGESTION (1).
	 */
	REMOTE_VIDEO_STATE_FROZEN REMOTE_VIDEO_STATE = C.REMOTE_VIDEO_STATE_FROZEN
	/** 4: The remote video fails to start. The SDK reports this state in the case of
	 * `REMOTE_VIDEO_STATE_REASON_INTERNAL (0)`.
	 */
	REMOTE_VIDEO_STATE_FAILED REMOTE_VIDEO_STATE = C.REMOTE_VIDEO_STATE_FAILED
)

/**
 * The reason for the remote video state change.
 */
type REMOTE_VIDEO_STATE_REASON C.enum_C_REMOTE_VIDEO_STATE_REASON

const (
	/**
	 * 0: The SDK reports this reason when the video state changes.
	 */
	REMOTE_VIDEO_STATE_REASON_INTERNAL REMOTE_VIDEO_STATE_REASON = C.REMOTE_VIDEO_STATE_REASON_INTERNAL
	/**
	 * 1: Network congestion.
	 */
	REMOTE_VIDEO_STATE_REASON_NETWORK_CONGESTION REMOTE_VIDEO_STATE_REASON = C.REMOTE_VIDEO_STATE_REASON_NETWORK_CONGESTION
	/**
	 * 2: Network recovery.
	 */
	REMOTE_VIDEO_STATE_REASON_NETWORK_RECOVERY REMOTE_VIDEO_STATE_REASON = C.REMOTE_VIDEO_STATE_REASON_NETWORK_RECOVERY
	/**
	 * 3: The local user stops receiving the remote video stream or disables the video module.
	 */
	REMOTE_VIDEO_STATE_REASON_LOCAL_MUTED REMOTE_VIDEO_STATE_REASON = C.REMOTE_VIDEO_STATE_REASON_LOCAL_MUTED
	/**
	 * 4: The local user resumes receiving the remote video stream or enables the video module.
	 */
	REMOTE_VIDEO_STATE_REASON_LOCAL_UNMUTED REMOTE_VIDEO_STATE_REASON = C.REMOTE_VIDEO_STATE_REASON_LOCAL_UNMUTED
	/**
	 * 5: The remote user stops sending the video stream or disables the video module.
	 */
	REMOTE_VIDEO_STATE_REASON_REMOTE_MUTED REMOTE_VIDEO_STATE_REASON = C.REMOTE_VIDEO_STATE_REASON_REMOTE_MUTED
	/**
	 * 6: The remote user resumes sending the video stream or enables the video module.
	 */
	REMOTE_VIDEO_STATE_REASON_REMOTE_UNMUTED REMOTE_VIDEO_STATE_REASON = C.REMOTE_VIDEO_STATE_REASON_REMOTE_UNMUTED
	/**
	 * 7: The remote user leaves the channel.
	 */
	REMOTE_VIDEO_STATE_REASON_REMOTE_OFFLINE REMOTE_VIDEO_STATE_REASON = C.REMOTE_VIDEO_STATE_REASON_REMOTE_OFFLINE
	/** 8: The remote audio-and-video stream falls back to the audio-only stream
	 * due to poor network conditions.
	 */
	REMOTE_VIDEO_STATE_REASON_AUDIO_FALLBACK REMOTE_VIDEO_STATE_REASON = C.REMOTE_VIDEO_STATE_REASON_AUDIO_FALLBACK
	/** 9: The remote audio-only stream switches back to the audio-and-video
	 * stream after the network conditions improve.
	 */
	REMOTE_VIDEO_STATE_REASON_AUDIO_FALLBACK_RECOVERY REMOTE_VIDEO_STATE_REASON = C.REMOTE_VIDEO_STATE_REASON_AUDIO_FALLBACK_RECOVERY
	/** (Internal use only) 10: The remote video stream type change to low stream type
	 */
	REMOTE_VIDEO_STATE_REASON_VIDEO_STREAM_TYPE_CHANGE_TO_LOW REMOTE_VIDEO_STATE_REASON = C.REMOTE_VIDEO_STATE_REASON_VIDEO_STREAM_TYPE_CHANGE_TO_LOW
	/** (Internal use only)  11: The remote video stream type change to high stream type
	 */
	REMOTE_VIDEO_STATE_REASON_VIDEO_STREAM_TYPE_CHANGE_TO_HIGH REMOTE_VIDEO_STATE_REASON = C.REMOTE_VIDEO_STATE_REASON_VIDEO_STREAM_TYPE_CHANGE_TO_HIGH
	/** (iOS only) 12: The app of the remote user is in background.
	 */
	REMOTE_VIDEO_STATE_REASON_SDK_IN_BACKGROUND REMOTE_VIDEO_STATE_REASON = C.REMOTE_VIDEO_STATE_REASON_SDK_IN_BACKGROUND

	/** 13: The remote video stream is not supported by the decoder
	 */
	REMOTE_VIDEO_STATE_REASON_CODEC_NOT_SUPPORT REMOTE_VIDEO_STATE_REASON = C.REMOTE_VIDEO_STATE_REASON_CODEC_NOT_SUPPORT
)

/**
 * The remote user state information.
 */
type REMOTE_USER_STATE C.enum_C_REMOTE_USER_STATE

const (
	/**
	 * The remote user has muted the audio.
	 */
	USER_STATE_MUTE_AUDIO REMOTE_USER_STATE = C.USER_STATE_MUTE_AUDIO
	/**
	 * The remote user has muted the video.
	 */
	USER_STATE_MUTE_VIDEO REMOTE_USER_STATE = C.USER_STATE_MUTE_VIDEO
	/**
	 * The remote user has enabled the video, which includes video capturing and encoding.
	 */
	USER_STATE_ENABLE_VIDEO REMOTE_USER_STATE = C.USER_STATE_ENABLE_VIDEO
	/**
	 * The remote user has enabled the local video capturing.
	 */
	USER_STATE_ENABLE_LOCAL_VIDEO REMOTE_USER_STATE = C.USER_STATE_ENABLE_LOCAL_VIDEO
)
 ...
 * the video track.
 */
type VideoTrackInfo C.struct_C_VideoTrackInfo
 ...
 */
type REMOTE_VIDEO_DOWNSCALE_LEVEL C.enum_C_REMOTE_VIDEO_DOWNSCALE_LEVEL

const (
	/**
	 * No downscale.
	 */
	REMOTE_VIDEO_DOWNSCALE_LEVEL_NONE REMOTE_VIDEO_DOWNSCALE_LEVEL = C.REMOTE_VIDEO_DOWNSCALE_LEVEL_NONE
	/**
	 * Downscale level 1.
	 */
	REMOTE_VIDEO_DOWNSCALE_LEVEL_1 REMOTE_VIDEO_DOWNSCALE_LEVEL = C.REMOTE_VIDEO_DOWNSCALE_LEVEL_1
	/**
	 * Downscale level 2.
	 */
	REMOTE_VIDEO_DOWNSCALE_LEVEL_2 REMOTE_VIDEO_DOWNSCALE_LEVEL = C.REMOTE_VIDEO_DOWNSCALE_LEVEL_2
	/**
	 * Downscale level 3.
	 */
	REMOTE_VIDEO_DOWNSCALE_LEVEL_3 REMOTE_VIDEO_DOWNSCALE_LEVEL = C.REMOTE_VIDEO_DOWNSCALE_LEVEL_3
	/**
	 * Downscale level 4.
	 */
	REMOTE_VIDEO_DOWNSCALE_LEVEL_4 REMOTE_VIDEO_DOWNSCALE_LEVEL = C.REMOTE_VIDEO_DOWNSCALE_LEVEL_4
)
 ...
 */
type AUDIO_SAMPLE_RATE_TYPE C.enum_C_AUDIO_SAMPLE_RATE_TYPE

const (
	/**
	 * 32000: 32 KHz.
	 */
	AUDIO_SAMPLE_RATE_32000 AUDIO_SAMPLE_RATE_TYPE = C.AUDIO_SAMPLE_RATE_32000
	/**
	 * 44100: 44.1 KHz.
	 */
	AUDIO_SAMPLE_RATE_44100 AUDIO_SAMPLE_RATE_TYPE = C.AUDIO_SAMPLE_RATE_44100
	/**
	 * 48000: 48 KHz.
	 */
	AUDIO_SAMPLE_RATE_48000 AUDIO_SAMPLE_RATE_TYPE = C.AUDIO_SAMPLE_RATE_48000
)

/**
 * The codec type of the output video.
 */
type VIDEO_CODEC_TYPE_FOR_STREAM C.enum_C_VIDEO_CODEC_TYPE_FOR_STREAM

const (
	/**
	 * 1: H.264.
	 */
	VIDEO_CODEC_H264_FOR_STREAM VIDEO_CODEC_TYPE_FOR_STREAM = C.VIDEO_CODEC_H264_FOR_STREAM
	/**
	 * 2: H.265.
	 */
	VIDEO_CODEC_H265_FOR_STREAM VIDEO_CODEC_TYPE_FOR_STREAM = C.VIDEO_CODEC_H265_FOR_STREAM
)

/**
 * Video codec profile types.
 */
type VIDEO_CODEC_PROFILE_TYPE C.enum_C_VIDEO_CODEC_PROFILE_TYPE

const (
	/**
	 * 66: Baseline video codec profile. Generally used in video calls on mobile phones.
	 */
	VIDEO_CODEC_PROFILE_BASELINE VIDEO_CODEC_PROFILE_TYPE = C.VIDEO_CODEC_PROFILE_BASELINE
	/**
	 * 77: Main video codec profile. Generally used in mainstream electronics, such as MP4 players, portable video players, PSP, and iPads.
	 */
	VIDEO_CODEC_PROFILE_MAIN VIDEO_CODEC_PROFILE_TYPE = C.VIDEO_CODEC_PROFILE_MAIN
	/**
	 * 100: High video codec profile. Generally used in high-resolution broadcasts or television.
	 */
	VIDEO_CODEC_PROFILE_HIGH VIDEO_CODEC_PROFILE_TYPE = C.VIDEO_CODEC_PROFILE_HIGH
)

/**
 * Self-defined audio codec profile.
 */
type AUDIO_CODEC_PROFILE_TYPE C.enum_C_AUDIO_CODEC_PROFILE_TYPE

const (
	/**
	 * 0: LC-AAC.
	 */
	AUDIO_CODEC_PROFILE_LC_AAC AUDIO_CODEC_PROFILE_TYPE = C.AUDIO_CODEC_PROFILE_LC_AAC
	/**
	 * 1: HE-AAC.
	 */
	AUDIO_CODEC_PROFILE_HE_AAC AUDIO_CODEC_PROFILE_TYPE = C.AUDIO_CODEC_PROFILE_HE_AAC
	/**
	 *  2: HE-AAC v2.
	 */
	AUDIO_CODEC_PROFILE_HE_AAC_V2 AUDIO_CODEC_PROFILE_TYPE = C.AUDIO_CODEC_PROFILE_HE_AAC_V2
)

/**
 * Local audio statistics.
 */
type LocalAudioStats C.struct_C_LocalAudioStats
 ...
 */
type RTMP_STREAM_PUBLISH_STATE C.enum_C_RTMP_STREAM_PUBLISH_STATE
...
const (
	 ...
	 */
	RTMP_STREAM_PUBLISH_STATE_IDLE RTMP_STREAM_PUBLISH_STATE = C.RTMP_STREAM_PUBLISH_STATE_IDLE
	/**
	 ...
	 */
	RTMP_STREAM_PUBLISH_STATE_CONNECTING RTMP_STREAM_PUBLISH_STATE = C.RTMP_STREAM_PUBLISH_STATE_CONNECTING
	/**
	 ...
	 */
	RTMP_STREAM_PUBLISH_STATE_RUNNING RTMP_STREAM_PUBLISH_STATE = C.RTMP_STREAM_PUBLISH_STATE_RUNNING
	/**
	 ...
	 */
	RTMP_STREAM_PUBLISH_STATE_RECOVERING RTMP_STREAM_PUBLISH_STATE = C.RTMP_STREAM_PUBLISH_STATE_RECOVERING
	/**
	 ...
	 */
	RTMP_STREAM_PUBLISH_STATE_FAILURE RTMP_STREAM_PUBLISH_STATE = C.RTMP_STREAM_PUBLISH_STATE_FAILURE
	/**
	 ...
	 */
	RTMP_STREAM_PUBLISH_STATE_DISCONNECTING RTMP_STREAM_PUBLISH_STATE = C.RTMP_STREAM_PUBLISH_STATE_DISCONNECTING
)

/**
 * Error codes of the RTMP or RTMPS streaming.
 */
type RTMP_STREAM_PUBLISH_ERROR_TYPE C.enum_C_RTMP_STREAM_PUBLISH_ERROR_TYPE

const (
	/**
	 * 0: The RTMP or RTMPS streaming publishes successfully.
	 */
	RTMP_STREAM_PUBLISH_ERROR_OK RTMP_STREAM_PUBLISH_ERROR_TYPE = C.RTMP_STREAM_PUBLISH_ERROR_OK
	/**
	 ...
	 */
	RTMP_STREAM_PUBLISH_ERROR_INVALID_ARGUMENT RTMP_STREAM_PUBLISH_ERROR_TYPE = C.RTMP_STREAM_PUBLISH_ERROR_INVALID_ARGUMENT
	/**
	 * 2: The RTMP or RTMPS streaming is encrypted and cannot be published.
	 */
	RTMP_STREAM_PUBLISH_ERROR_ENCRYPTED_STREAM_NOT_ALLOWED RTMP_STREAM_PUBLISH_ERROR_TYPE = C.RTMP_STREAM_PUBLISH_ERROR_ENCRYPTED_STREAM_NOT_ALLOWED
	/**
	 * 3: Timeout for the RTMP or RTMPS streaming. Call the `addPublishStreamUrl` method to publish the streaming again.
	 */
	RTMP_STREAM_PUBLISH_ERROR_CONNECTION_TIMEOUT RTMP_STREAM_PUBLISH_ERROR_TYPE = C.RTMP_STREAM_PUBLISH_ERROR_CONNECTION_TIMEOUT
	/**
	 * 4: An error occurs in Agora's streaming server. Call the `addPublishStreamUrl` method to publish the streaming again.
	 */
	RTMP_STREAM_PUBLISH_ERROR_INTERNAL_SERVER_ERROR RTMP_STREAM_PUBLISH_ERROR_TYPE = C.RTMP_STREAM_PUBLISH_ERROR_INTERNAL_SERVER_ERROR
	/**
	 * 5: An error occurs in the CDN server.
	 */
	RTMP_STREAM_PUBLISH_ERROR_RTMP_SERVER_ERROR RTMP_STREAM_PUBLISH_ERROR_TYPE = C.RTMP_STREAM_PUBLISH_ERROR_RTMP_SERVER_ERROR
	/**
	 * 6: The RTMP or RTMPS streaming publishes too frequently.
	 */
	RTMP_STREAM_PUBLISH_ERROR_TOO_OFTEN RTMP_STREAM_PUBLISH_ERROR_TYPE = C.RTMP_STREAM_PUBLISH_ERROR_TOO_OFTEN
	/**
	 * 7: The host publishes more than 10 URLs. Delete the unnecessary URLs before adding new ones.
	 */
	RTMP_STREAM_PUBLISH_ERROR_REACH_LIMIT RTMP_STREAM_PUBLISH_ERROR_TYPE = C.RTMP_STREAM_PUBLISH_ERROR_REACH_LIMIT
	/**
	 * 8: The host manipulates other hosts' URLs. Check your app logic.
	 */
	RTMP_STREAM_PUBLISH_ERROR_NOT_AUTHORIZED RTMP_STREAM_PUBLISH_ERROR_TYPE = C.RTMP_STREAM_PUBLISH_ERROR_NOT_AUTHORIZED
	/**
	 * 9: Agora's server fails to find the RTMP or RTMPS streaming.
	 */
	RTMP_STREAM_PUBLISH_ERROR_STREAM_NOT_FOUND RTMP_STREAM_PUBLISH_ERROR_TYPE = C.RTMP_STREAM_PUBLISH_ERROR_STREAM_NOT_FOUND
	/**
	 * 10: The format of the RTMP or RTMPS streaming URL is not supported. Check whether the URL format is correct.
	 */
	RTMP_STREAM_PUBLISH_ERROR_FORMAT_NOT_SUPPORTED RTMP_STREAM_PUBLISH_ERROR_TYPE = C.RTMP_STREAM_PUBLISH_ERROR_FORMAT_NOT_SUPPORTED
	/**
	 * 11: The user role is not host, so the user cannot use the CDN live streaming function. Check your application code logic.
	 */
	RTMP_STREAM_PUBLISH_ERROR_NOT_BROADCASTER RTMP_STREAM_PUBLISH_ERROR_TYPE = C.RTMP_STREAM_PUBLISH_ERROR_NOT_BROADCASTER
	/**
	 ...
	 */
	RTMP_STREAM_PUBLISH_ERROR_TRANSCODING_NO_MIX_STREAM RTMP_STREAM_PUBLISH_ERROR_TYPE = C.RTMP_STREAM_PUBLISH_ERROR_TRANSCODING_NO_MIX_STREAM
	/**
	 * 14: Errors occurred in the host's network.
	 */
	RTMP_STREAM_PUBLISH_ERROR_NET_DOWN RTMP_STREAM_PUBLISH_ERROR_TYPE = C.RTMP_STREAM_PUBLISH_ERROR_NET_DOWN
	/**
	 * 15: Your App ID does not have permission to use the CDN live streaming function.
	 */
	RTMP_STREAM_PUBLISH_ERROR_INVALID_APPID RTMP_STREAM_PUBLISH_ERROR_TYPE = C.RTMP_STREAM_PUBLISH_ERROR_INVALID_APPID
	/** invalid privilege. */
	RTMP_STREAM_PUBLISH_ERROR_INVALID_PRIVILEGE RTMP_STREAM_PUBLISH_ERROR_TYPE = C.RTMP_STREAM_PUBLISH_ERROR_INVALID_PRIVILEGE
	/**
	 ...
	 */
	RTMP_STREAM_UNPUBLISH_ERROR_OK RTMP_STREAM_PUBLISH_ERROR_TYPE = C.RTMP_STREAM_UNPUBLISH_ERROR_OK
)

/** Events during the RTMP or RTMPS streaming. */
type RTMP_STREAMING_EVENT C.enum_C_RTMP_STREAMING_EVENT

const (
	/**
	 * 1: An error occurs when you add a background image or a watermark image to the RTMP or RTMPS stream.
	 */
	RTMP_STREAMING_EVENT_FAILED_LOAD_IMAGE RTMP_STREAMING_EVENT = C.RTMP_STREAMING_EVENT_FAILED_LOAD_IMAGE
	/**
	 ...
	 */
	RTMP_STREAMING_EVENT_URL_ALREADY_IN_USE RTMP_STREAMING_EVENT = C.RTMP_STREAMING_EVENT_URL_ALREADY_IN_USE
	/**
	 * 3: The feature is not supported.
	 */
	RTMP_STREAMING_EVENT_ADVANCED_FEATURE_NOT_SUPPORT RTMP_STREAMING_EVENT = C.RTMP_STREAMING_EVENT_ADVANCED_FEATURE_NOT_SUPPORT
	/**
	 * 4: Client request too frequently.
	 */
	RTMP_STREAMING_EVENT_REQUEST_TOO_OFTEN RTMP_STREAMING_EVENT = C.RTMP_STREAMING_EVENT_REQUEST_TOO_OFTEN
)
 ...
 */
type CONNECTION_STATE_TYPE C.enum_C_CONNECTION_STATE_TYPE
...
const (
	 ...
	 */
	CONNECTION_STATE_DISCONNECTED CONNECTION_STATE_TYPE = C.CONNECTION_STATE_DISCONNECTED
	/**
	 ...
	 */
	CONNECTION_STATE_CONNECTING CONNECTION_STATE_TYPE = C.CONNECTION_STATE_CONNECTING
	/**
	 ...
	 */
	CONNECTION_STATE_CONNECTED CONNECTION_STATE_TYPE = C.CONNECTION_STATE_CONNECTED
	/**
	 ...
	 */
	CONNECTION_STATE_RECONNECTING CONNECTION_STATE_TYPE = C.CONNECTION_STATE_RECONNECTING
	/**
	 ...
	 */
	CONNECTION_STATE_FAILED CONNECTION_STATE_TYPE = C.CONNECTION_STATE_FAILED
)
...
type VIDEO_TRANSCODER_ERROR C.enum_C_VIDEO_TRANSCODER_ERROR

const (
	/**
	 * The video track of the video source is not started.
	 */
	VT_ERR_VIDEO_SOURCE_NOT_READY VIDEO_TRANSCODER_ERROR = C.VT_ERR_VIDEO_SOURCE_NOT_READY
	/**
	 * The video source type is not supported.
	 */
	VT_ERR_INVALID_VIDEO_SOURCE_TYPE VIDEO_TRANSCODER_ERROR = C.VT_ERR_INVALID_VIDEO_SOURCE_TYPE
	/**
	 * The image url is not correctly of image source.
	 */
	VT_ERR_INVALID_IMAGE_PATH VIDEO_TRANSCODER_ERROR = C.VT_ERR_INVALID_IMAGE_PATH
	/**
	 * The image format not the type png/jpeg/gif of image source.
	 */
	VT_ERR_UNSUPPORT_IMAGE_FORMAT VIDEO_TRANSCODER_ERROR = C.VT_ERR_UNSUPPORT_IMAGE_FORMAT
	/**
	 * The layout is invalid such as width is zero.
	 */
	VT_ERR_INVALID_LAYOUT VIDEO_TRANSCODER_ERROR = C.VT_ERR_INVALID_LAYOUT
	/**
	 * Internal error.
	 */
	VT_ERR_INTERNAL VIDEO_TRANSCODER_ERROR = C.VT_ERR_INTERNAL
)
 ...
 */
type LASTMILE_PROBE_RESULT_STATE C.enum_C_LASTMILE_PROBE_RESULT_STATE

const (
	/**
	 * 1: The last-mile network probe test is complete.
	 */
	LASTMILE_PROBE_RESULT_COMPLETE LASTMILE_PROBE_RESULT_STATE = C.LASTMILE_PROBE_RESULT_COMPLETE
	/**
	 ...
	 */
	LASTMILE_PROBE_RESULT_INCOMPLETE_NO_BWE LASTMILE_PROBE_RESULT_STATE = C.LASTMILE_PROBE_RESULT_INCOMPLETE_NO_BWE
	/**
	 * 3: The last-mile network probe test is not carried out, probably due to poor network conditions.
	 */
	LASTMILE_PROBE_RESULT_UNAVAILABLE LASTMILE_PROBE_RESULT_STATE = C.LASTMILE_PROBE_RESULT_UNAVAILABLE
)
 ...
 */
type LastmileProbeResult C.struct_C_LastmileProbeResult
 ...
 */
type CONNECTION_CHANGED_REASON_TYPE C.enum_C_CONNECTION_CHANGED_REASON_TYPE

const (
	/**
	 * 0: The SDK is connecting to the server.
	 */
	CONNECTION_CHANGED_CONNECTING CONNECTION_CHANGED_REASON_TYPE = C.CONNECTION_CHANGED_CONNECTING
	/**
	 * 1: The SDK has joined the channel successfully.
	 */
	CONNECTION_CHANGED_JOIN_SUCCESS CONNECTION_CHANGED_REASON_TYPE = C.CONNECTION_CHANGED_JOIN_SUCCESS
	/**
	 * 2: The connection between the SDK and the server is interrupted.
	 */
	CONNECTION_CHANGED_INTERRUPTED CONNECTION_CHANGED_REASON_TYPE = C.CONNECTION_CHANGED_INTERRUPTED
	/**
	 ...
	 */
	CONNECTION_CHANGED_BANNED_BY_SERVER CONNECTION_CHANGED_REASON_TYPE = C.CONNECTION_CHANGED_BANNED_BY_SERVER
	/**
	 ...
	 */
	CONNECTION_CHANGED_JOIN_FAILED CONNECTION_CHANGED_REASON_TYPE = C.CONNECTION_CHANGED_JOIN_FAILED
	/**
	 * 5: The SDK has left the channel.
	 */
	CONNECTION_CHANGED_LEAVE_CHANNEL CONNECTION_CHANGED_REASON_TYPE = C.CONNECTION_CHANGED_LEAVE_CHANNEL
	/**
	 * 6: The connection fails because the App ID is not valid.
	 */
	CONNECTION_CHANGED_INVALID_APP_ID CONNECTION_CHANGED_REASON_TYPE = C.CONNECTION_CHANGED_INVALID_APP_ID
	/**
	 * 7: The connection fails because the channel name is not valid. Please rejoin the channel with a valid channel name.
	 */
	CONNECTION_CHANGED_INVALID_CHANNEL_NAME CONNECTION_CHANGED_REASON_TYPE = C.CONNECTION_CHANGED_INVALID_CHANNEL_NAME
	/**
	 ...
	 */
	CONNECTION_CHANGED_INVALID_TOKEN CONNECTION_CHANGED_REASON_TYPE = C.CONNECTION_CHANGED_INVALID_TOKEN
	/**
	 * 9: The connection fails because the token has expired.
	 */
	CONNECTION_CHANGED_TOKEN_EXPIRED CONNECTION_CHANGED_REASON_TYPE = C.CONNECTION_CHANGED_TOKEN_EXPIRED
	/**
	 ...
	 */
	CONNECTION_CHANGED_REJECTED_BY_SERVER CONNECTION_CHANGED_REASON_TYPE = C.CONNECTION_CHANGED_REJECTED_BY_SERVER
	/**
	 * 11: The connection changes to reconnecting because the SDK has set a proxy server.
	 */
	CONNECTION_CHANGED_SETTING_PROXY_SERVER CONNECTION_CHANGED_REASON_TYPE = C.CONNECTION_CHANGED_SETTING_PROXY_SERVER
	/**
	 * 12: The connection state changed because the token is renewed.
	 */
	CONNECTION_CHANGED_RENEW_TOKEN CONNECTION_CHANGED_REASON_TYPE = C.CONNECTION_CHANGED_RENEW_TOKEN
	/**
	 * 13: The IP address of the client has changed, possibly because the network type, IP address, or port has been changed.
	 */
	CONNECTION_CHANGED_CLIENT_IP_ADDRESS_CHANGED CONNECTION_CHANGED_REASON_TYPE = C.CONNECTION_CHANGED_CLIENT_IP_ADDRESS_CHANGED
	/**
	 ...
	 */
	CONNECTION_CHANGED_KEEP_ALIVE_TIMEOUT CONNECTION_CHANGED_REASON_TYPE = C.CONNECTION_CHANGED_KEEP_ALIVE_TIMEOUT
	/**
	 * 15: The SDK has rejoined the channel successfully.
	 */
	CONNECTION_CHANGED_REJOIN_SUCCESS CONNECTION_CHANGED_REASON_TYPE = C.CONNECTION_CHANGED_REJOIN_SUCCESS
	/**
	 * 16: The connection between the SDK and the server is lost.
	 */
	CONNECTION_CHANGED_LOST CONNECTION_CHANGED_REASON_TYPE = C.CONNECTION_CHANGED_LOST
	/**
	 * 17: The change of connection state is caused by echo test.
	 */
	CONNECTION_CHANGED_ECHO_TEST CONNECTION_CHANGED_REASON_TYPE = C.CONNECTION_CHANGED_ECHO_TEST
	/**
	 * 18: The local IP Address is changed by user.
	 */
	CONNECTION_CHANGED_CLIENT_IP_ADDRESS_CHANGED_BY_USER CONNECTION_CHANGED_REASON_TYPE = C.CONNECTION_CHANGED_CLIENT_IP_ADDRESS_CHANGED_BY_USER
	/**
	 * 19: The connection is failed due to join the same channel on another device with the same uid.
	 */
	CONNECTION_CHANGED_SAME_UID_LOGIN CONNECTION_CHANGED_REASON_TYPE = C.CONNECTION_CHANGED_SAME_UID_LOGIN
	/**
	 * 20: The connection is failed due to too many broadcasters in the channel.
	 */
	CONNECTION_CHANGED_TOO_MANY_BROADCASTERS CONNECTION_CHANGED_REASON_TYPE = C.CONNECTION_CHANGED_TOO_MANY_BROADCASTERS

	/**
	 * 21: The connection is failed due to license validation failure.
	 */
	CONNECTION_CHANGED_LICENSE_VALIDATION_FAILURE CONNECTION_CHANGED_REASON_TYPE = C.CONNECTION_CHANGED_LICENSE_VALIDATION_FAILURE
	/**
	 * 22: The connection is failed due to certification verify failure.
	 */
	CONNECTION_CHANGED_CERTIFICATION_VERYFY_FAILURE CONNECTION_CHANGED_REASON_TYPE = C.CONNECTION_CHANGED_CERTIFICATION_VERYFY_FAILURE
)

/**
 * The reason of changing role's failure.
 */
type CLIENT_ROLE_CHANGE_FAILED_REASON C.enum_C_CLIENT_ROLE_CHANGE_FAILED_REASON

const (
	/**
	 * 1: Too many broadcasters in the channel.
	 */
	CLIENT_ROLE_CHANGE_FAILED_TOO_MANY_BROADCASTERS CLIENT_ROLE_CHANGE_FAILED_REASON = C.CLIENT_ROLE_CHANGE_FAILED_TOO_MANY_BROADCASTERS
	/**
	 * 2: The operation of changing role is not authorized.
	 */
	CLIENT_ROLE_CHANGE_FAILED_NOT_AUTHORIZED CLIENT_ROLE_CHANGE_FAILED_REASON = C.CLIENT_ROLE_CHANGE_FAILED_NOT_AUTHORIZED
	/**
	 * 3: The operation of changing role is timeout.
	 */
	CLIENT_ROLE_CHANGE_FAILED_REQUEST_TIME_OUT CLIENT_ROLE_CHANGE_FAILED_REASON = C.CLIENT_ROLE_CHANGE_FAILED_REQUEST_TIME_OUT
	/**
	 * 4: The operation of changing role is interrupted since we lost connection with agora service.
	 */
	CLIENT_ROLE_CHANGE_FAILED_CONNECTION_FAILED CLIENT_ROLE_CHANGE_FAILED_REASON = C.CLIENT_ROLE_CHANGE_FAILED_CONNECTION_FAILED
)

/**
 * The reason of notifying the user of a message.
 */
type WLACC_MESSAGE_REASON C.enum_C_WLACC_MESSAGE_REASON

const (
	/**
	 * WIFI signal is weak.
	 */
	WLACC_MESSAGE_REASON_WEAK_SIGNAL WLACC_MESSAGE_REASON = C.WLACC_MESSAGE_REASON_WEAK_SIGNAL
	/**
	 * Channel congestion.
	 */
	WLACC_MESSAGE_REASON_CHANNEL_CONGESTION WLACC_MESSAGE_REASON = C.WLACC_MESSAGE_REASON_CHANNEL_CONGESTION
)

/**
 * Suggest an action for the user.
 */
type WLACC_SUGGEST_ACTION C.enum_C_WLACC_SUGGEST_ACTION

const (
	/**
	 * Please get close to AP.
	 */
	WLACC_SUGGEST_ACTION_CLOSE_TO_WIFI WLACC_SUGGEST_ACTION = C.WLACC_SUGGEST_ACTION_CLOSE_TO_WIFI
	/**
	 * The user is advised to connect to the prompted SSID.
	 */
	WLACC_SUGGEST_ACTION_CONNECT_SSID WLACC_SUGGEST_ACTION = C.WLACC_SUGGEST_ACTION_CONNECT_SSID
	/**
	 ...
	 */
	WLACC_SUGGEST_ACTION_CHECK_5G WLACC_SUGGEST_ACTION = C.WLACC_SUGGEST_ACTION_CHECK_5G
	/**
	 ...
	 */
	WLACC_SUGGEST_ACTION_MODIFY_SSID WLACC_SUGGEST_ACTION = C.WLACC_SUGGEST_ACTION_MODIFY_SSID
)
...
type WlAccStats C.struct_C_WlAccStats
 ...
 * The network type.
 */
type NETWORK_TYPE C.enum_C_NETWORK_TYPE

const (
	/**
	 * -1: The network type is unknown.
	 */
	NETWORK_TYPE_UNKNOWN NETWORK_TYPE = C.NETWORK_TYPE_UNKNOWN
	/**
	 * 0: The SDK disconnects from the network.
	 */
	NETWORK_TYPE_DISCONNECTED NETWORK_TYPE = C.NETWORK_TYPE_DISCONNECTED
	/**
	 * 1: The network type is LAN.
	 */
	NETWORK_TYPE_LAN NETWORK_TYPE = C.NETWORK_TYPE_LAN
	/**
	 * 2: The network type is Wi-Fi (including hotspots).
	 */
	NETWORK_TYPE_WIFI NETWORK_TYPE = C.NETWORK_TYPE_WIFI
	/**
	 * 3: The network type is mobile 2G.
	 */
	NETWORK_TYPE_MOBILE_2G NETWORK_TYPE = C.NETWORK_TYPE_MOBILE_2G
	/**
	 * 4: The network type is mobile 3G.
	 */
	NETWORK_TYPE_MOBILE_3G NETWORK_TYPE = C.NETWORK_TYPE_MOBILE_3G
	/**
	 * 5: The network type is mobile 4G.
	 */
	NETWORK_TYPE_MOBILE_4G NETWORK_TYPE = C.NETWORK_TYPE_MOBILE_4G
	/**
	 * 6: The network type is mobile 5G.
	 */
	NETWORK_TYPE_MOBILE_5G NETWORK_TYPE = C.NETWORK_TYPE_MOBILE_5G
)

/**
 * The mode of setting up video views.
 */
type VIDEO_VIEW_SETUP_MODE C.enum_C_VIDEO_VIEW_SETUP_MODE

const (
	/**
	 * 0: replace one view
	 */
	VIDEO_VIEW_SETUP_REPLACE VIDEO_VIEW_SETUP_MODE = C.VIDEO_VIEW_SETUP_REPLACE
	/**
	 * 1: add one view
	 */
	VIDEO_VIEW_SETUP_ADD VIDEO_VIEW_SETUP_MODE = C.VIDEO_VIEW_SETUP_ADD
	/**
	 * 2: remove one view
	 */
	VIDEO_VIEW_SETUP_REMOVE VIDEO_VIEW_SETUP_MODE = C.VIDEO_VIEW_SETUP_REMOVE
)
...
/** The contrast level.
 */
type LIGHTENING_CONTRAST_LEVEL C.enum_C_LIGHTENING_CONTRAST_LEVEL

const (
	/** Low contrast level. */
	LIGHTENING_CONTRAST_LOW LIGHTENING_CONTRAST_LEVEL = C.LIGHTENING_CONTRAST_LOW
	/** (Default) Normal contrast level. */
	LIGHTENING_CONTRAST_NORMAL LIGHTENING_CONTRAST_LEVEL = C.LIGHTENING_CONTRAST_NORMAL
	/** High contrast level. */
	LIGHTENING_CONTRAST_HIGH LIGHTENING_CONTRAST_LEVEL = C.LIGHTENING_CONTRAST_HIGH
)
 ...
 */
type LOW_LIGHT_ENHANCE_MODE C.enum_C_LOW_LIGHT_ENHANCE_MODE

const (
	/** 0: (Default) Automatic mode. The SDK automatically enables or disables the low-light enhancement feature according to the ambient light to compensate for the lighting level or prevent overexposure, as necessary. */
	LOW_LIGHT_ENHANCE_AUTO LOW_LIGHT_ENHANCE_MODE = C.LOW_LIGHT_ENHANCE_AUTO
	/** Manual mode. Users need to enable or disable the low-light enhancement feature manually. */
	LOW_LIGHT_ENHANCE_MANUAL LOW_LIGHT_ENHANCE_MODE = C.LOW_LIGHT_ENHANCE_MANUAL
)

/**
 * The low-light enhancement level.
 */
type LOW_LIGHT_ENHANCE_LEVEL C.enum_C_LOW_LIGHT_ENHANCE_LEVEL

const (
	/**
	 * 0: (Default) Promotes video quality during low-light enhancement. It processes the brightness, details, and noise of the video image. The performance consumption is moderate, the processing speed is moderate, and the overall video quality is optimal.
	 */
	LOW_LIGHT_ENHANCE_LEVEL_HIGH_QUALITY LOW_LIGHT_ENHANCE_LEVEL = C.LOW_LIGHT_ENHANCE_LEVEL_HIGH_QUALITY
	/**
	 ...
	 */
	LOW_LIGHT_ENHANCE_LEVEL_FAST LOW_LIGHT_ENHANCE_LEVEL = C.LOW_LIGHT_ENHANCE_LEVEL_FAST
)
 ...
 */
type VIDEO_DENOISER_MODE C.enum_C_VIDEO_DENOISER_MODE

const (
	/** 0: (Default) Automatic mode. The SDK automatically enables or disables the video noise reduction feature according to the ambient light. */
	VIDEO_DENOISER_AUTO VIDEO_DENOISER_MODE = C.VIDEO_DENOISER_AUTO
	/** Manual mode. Users need to enable or disable the video noise reduction feature manually. */
	VIDEO_DENOISER_MANUAL VIDEO_DENOISER_MODE = C.VIDEO_DENOISER_MANUAL
)

/**
 * The video noise reduction level.
 */
type VIDEO_DENOISER_LEVEL C.enum_C_VIDEO_DENOISER_LEVEL
...
const (
	 ...
	 */
	VIDEO_DENOISER_LEVEL_HIGH_QUALITY VIDEO_DENOISER_LEVEL = C.VIDEO_DENOISER_LEVEL_HIGH_QUALITY
	/**
	 ...
	 */
	VIDEO_DENOISER_LEVEL_FAST VIDEO_DENOISER_LEVEL = C.VIDEO_DENOISER_LEVEL_FAST
	/**
	 ...
	 */
	VIDEO_DENOISER_LEVEL_STRENGTH VIDEO_DENOISER_LEVEL = C.VIDEO_DENOISER_LEVEL_STRENGTH
)
...
const (
	...
	BLUR_DEGREE_MEDIUM BACKGROUND_BLUR_DEGREE = C.BLUR_DEGREE_MEDIUM
	...
	BLUR_DEGREE_HIGH BACKGROUND_BLUR_DEGREE = C.BLUR_DEGREE_HIGH
)
...
type SEG_MODEL_TYPE C.enum_C_SEG_MODEL_TYPE

const (
	SEG_MODEL_AI    SEG_MODEL_TYPE = C.SEG_MODEL_AI
	SEG_MODEL_GREEN SEG_MODEL_TYPE = C.SEG_MODEL_GREEN
)
 ...
 */
type AUDIO_TRACK_TYPE C.enum_C_AUDIO_TRACK_TYPE

const (
	/**
	 * -1: Invalid audio track
	 */
	AUDIO_TRACK_INVALID AUDIO_TRACK_TYPE = C.AUDIO_TRACK_INVALID
	/**
	 ...
	 */
	AUDIO_TRACK_MIXABLE AUDIO_TRACK_TYPE = C.AUDIO_TRACK_MIXABLE
	/**
	 ...
	 */
	AUDIO_TRACK_DIRECT AUDIO_TRACK_TYPE = C.AUDIO_TRACK_DIRECT
)
 ...
 */
type VOICE_BEAUTIFIER_PRESET C.enum_C_VOICE_BEAUTIFIER_PRESET

const (
	/** Turn off voice beautifier effects and use the original voice.
	 */
	VOICE_BEAUTIFIER_OFF VOICE_BEAUTIFIER_PRESET = C.VOICE_BEAUTIFIER_OFF
	 ...
	 */
	CHAT_BEAUTIFIER_MAGNETIC VOICE_BEAUTIFIER_PRESET = C.CHAT_BEAUTIFIER_MAGNETIC
	/** A fresher voice.
	 *
	 * @note Agora recommends using this enumerator to process a female-sounding voice; otherwise, you
	 * may experience vocal distortion.
	 */
	CHAT_BEAUTIFIER_FRESH VOICE_BEAUTIFIER_PRESET = C.CHAT_BEAUTIFIER_FRESH
	/** A more vital voice.
	 *
	 * @note Agora recommends using this enumerator to process a female-sounding voice; otherwise, you
	 * may experience vocal distortion.
	 */
	CHAT_BEAUTIFIER_VITALITY VOICE_BEAUTIFIER_PRESET = C.CHAT_BEAUTIFIER_VITALITY
	/**
	 ...
	 */
	SINGING_BEAUTIFIER VOICE_BEAUTIFIER_PRESET = C.SINGING_BEAUTIFIER
	/** A more vigorous voice.
	 */
	TIMBRE_TRANSFORMATION_VIGOROUS VOICE_BEAUTIFIER_PRESET = C.TIMBRE_TRANSFORMATION_VIGOROUS
	/** A deeper voice.
	 */
	TIMBRE_TRANSFORMATION_DEEP VOICE_BEAUTIFIER_PRESET = C.TIMBRE_TRANSFORMATION_DEEP
	/** A mellower voice.
	 */
	TIMBRE_TRANSFORMATION_MELLOW VOICE_BEAUTIFIER_PRESET = C.TIMBRE_TRANSFORMATION_MELLOW
	/** A falsetto voice.
	 */
	TIMBRE_TRANSFORMATION_FALSETTO VOICE_BEAUTIFIER_PRESET = C.TIMBRE_TRANSFORMATION_FALSETTO
	/** A fuller voice.
	 */
	TIMBRE_TRANSFORMATION_FULL VOICE_BEAUTIFIER_PRESET = C.TIMBRE_TRANSFORMATION_FULL
	/** A clearer voice.
	 */
	TIMBRE_TRANSFORMATION_CLEAR VOICE_BEAUTIFIER_PRESET = C.TIMBRE_TRANSFORMATION_CLEAR
	/** A more resounding voice.
	 */
	TIMBRE_TRANSFORMATION_RESOUNDING VOICE_BEAUTIFIER_PRESET = C.TIMBRE_TRANSFORMATION_RESOUNDING
	/** A more ringing voice.
	 */
	TIMBRE_TRANSFORMATION_RINGING VOICE_BEAUTIFIER_PRESET = C.TIMBRE_TRANSFORMATION_RINGING
	/**
	 ...
	 */
	ULTRA_HIGH_QUALITY_VOICE VOICE_BEAUTIFIER_PRESET = C.ULTRA_HIGH_QUALITY_VOICE
)
 ...
 * - `PITCH_CORRECTION`
 */
type AUDIO_EFFECT_PRESET C.enum_C_AUDIO_EFFECT_PRESET

const (
	/** Turn off voice effects, that is, use the original voice.
	 */
	AUDIO_EFFECT_OFF AUDIO_EFFECT_PRESET = C.AUDIO_EFFECT_OFF
	/** The voice effect typical of a KTV venue.
	 */
	ROOM_ACOUSTICS_KTV AUDIO_EFFECT_PRESET = C.ROOM_ACOUSTICS_KTV
	/** The voice effect typical of a concert hall.
	 */
	ROOM_ACOUSTICS_VOCAL_CONCERT AUDIO_EFFECT_PRESET = C.ROOM_ACOUSTICS_VOCAL_CONCERT
	/** The voice effect typical of a recording studio.
	 */
	ROOM_ACOUSTICS_STUDIO AUDIO_EFFECT_PRESET = C.ROOM_ACOUSTICS_STUDIO
	/** The voice effect typical of a vintage phonograph.
	 */
	ROOM_ACOUSTICS_PHONOGRAPH AUDIO_EFFECT_PRESET = C.ROOM_ACOUSTICS_PHONOGRAPH
	 ...
	 */
	ROOM_ACOUSTICS_VIRTUAL_STEREO AUDIO_EFFECT_PRESET = C.ROOM_ACOUSTICS_VIRTUAL_STEREO
	/** A more spatial voice effect.
	 */
	ROOM_ACOUSTICS_SPACIAL AUDIO_EFFECT_PRESET = C.ROOM_ACOUSTICS_SPACIAL
	/** A more ethereal voice effect.
	 */
	ROOM_ACOUSTICS_ETHEREAL AUDIO_EFFECT_PRESET = C.ROOM_ACOUSTICS_ETHEREAL
	 ...
	 */
	ROOM_ACOUSTICS_3D_VOICE AUDIO_EFFECT_PRESET = C.ROOM_ACOUSTICS_3D_VOICE
	 ...
	 */
	ROOM_ACOUSTICS_VIRTUAL_SURROUND_SOUND AUDIO_EFFECT_PRESET = C.ROOM_ACOUSTICS_VIRTUAL_SURROUND_SOUND
	 ...
	 * not hear the anticipated voice effect.
	 */
	VOICE_CHANGER_EFFECT_UNCLE AUDIO_EFFECT_PRESET = C.VOICE_CHANGER_EFFECT_UNCLE
	/** A senior man's voice.
	 *
	 * @note Agora recommends using this enumerator to process a male-sounding voice; otherwise, you may
	 * not hear the anticipated voice effect.
	 */
	VOICE_CHANGER_EFFECT_OLDMAN AUDIO_EFFECT_PRESET = C.VOICE_CHANGER_EFFECT_OLDMAN
	/** A boy's voice.
	 *
	 * @note Agora recommends using this enumerator to process a male-sounding voice; otherwise, you may
	 * not hear the anticipated voice effect.
	 */
	VOICE_CHANGER_EFFECT_BOY AUDIO_EFFECT_PRESET = C.VOICE_CHANGER_EFFECT_BOY
	 ...
	 * not hear the anticipated voice effect.
	 */
	VOICE_CHANGER_EFFECT_SISTER AUDIO_EFFECT_PRESET = C.VOICE_CHANGER_EFFECT_SISTER
	/** A girl's voice.
	 *
	 * @note Agora recommends using this enumerator to process a female-sounding voice; otherwise, you may
	 * not hear the anticipated voice effect.
	 */
	VOICE_CHANGER_EFFECT_GIRL AUDIO_EFFECT_PRESET = C.VOICE_CHANGER_EFFECT_GIRL
	/** The voice of Pig King, a character in Journey to the West who has a voice like a growling
	 * bear.
	 */
	VOICE_CHANGER_EFFECT_PIGKING AUDIO_EFFECT_PRESET = C.VOICE_CHANGER_EFFECT_PIGKING
	/** The Hulk's voice.
	 */
	VOICE_CHANGER_EFFECT_HULK AUDIO_EFFECT_PRESET = C.VOICE_CHANGER_EFFECT_HULK
	/** An audio effect typical of R&B music.
	  ...
	  * the preset setting is invalid.
	*/
	STYLE_TRANSFORMATION_RNB AUDIO_EFFECT_PRESET = C.STYLE_TRANSFORMATION_RNB
	/** The voice effect typical of popular music.
	  ...
	  * the preset setting is invalid.
	*/
	STYLE_TRANSFORMATION_POPULAR AUDIO_EFFECT_PRESET = C.STYLE_TRANSFORMATION_POPULAR
	 ...
	 */
	PITCH_CORRECTION AUDIO_EFFECT_PRESET = C.PITCH_CORRECTION
 ...
 */
type VOICE_CONVERSION_PRESET C.enum_C_VOICE_CONVERSION_PRESET

const (
	/** Turn off voice conversion and use the original voice.
	 */
	VOICE_CONVERSION_OFF VOICE_CONVERSION_PRESET = C.VOICE_CONVERSION_OFF
	/** A gender-neutral voice. To avoid audio distortion, ensure that you use this enumerator to process a female-sounding voice.
	 */
	VOICE_CHANGER_NEUTRAL VOICE_CONVERSION_PRESET = C.VOICE_CHANGER_NEUTRAL
	/** A sweet voice. To avoid audio distortion, ensure that you use this enumerator to process a female-sounding voice.
	 */
	VOICE_CHANGER_SWEET VOICE_CONVERSION_PRESET = C.VOICE_CHANGER_SWEET
	/** A steady voice. To avoid audio distortion, ensure that you use this enumerator to process a male-sounding voice.
	 */
	VOICE_CHANGER_SOLID VOICE_CONVERSION_PRESET = C.VOICE_CHANGER_SOLID
	/** A deep voice. To avoid audio distortion, ensure that you use this enumerator to process a male-sounding voice.
	 */
	VOICE_CHANGER_BASS VOICE_CONVERSION_PRESET = C.VOICE_CHANGER_BASS
	/** A voice like a cartoon character.
	 */
	VOICE_CHANGER_CARTOON VOICE_CONVERSION_PRESET = C.VOICE_CHANGER_CARTOON
	/** A voice like a child.
	 */
	VOICE_CHANGER_CHILDLIKE VOICE_CONVERSION_PRESET = C.VOICE_CHANGER_CHILDLIKE
	/** A voice like a phone operator.
	 */
	VOICE_CHANGER_PHONE_OPERATOR VOICE_CONVERSION_PRESET = C.VOICE_CHANGER_PHONE_OPERATOR
	/** A monster voice.
	 */
	VOICE_CHANGER_MONSTER VOICE_CONVERSION_PRESET = C.VOICE_CHANGER_MONSTER
	/** A voice like Transformers.
	 */
	VOICE_CHANGER_TRANSFORMERS VOICE_CONVERSION_PRESET = C.VOICE_CHANGER_TRANSFORMERS
	/** A voice like Groot.
	 */
	VOICE_CHANGER_GROOT VOICE_CONVERSION_PRESET = C.VOICE_CHANGER_GROOT
	/** A voice like Darth Vader.
	 */
	VOICE_CHANGER_DARTH_VADER VOICE_CONVERSION_PRESET = C.VOICE_CHANGER_DARTH_VADER
	/** A rough female voice.
	 */
	VOICE_CHANGER_IRON_LADY VOICE_CONVERSION_PRESET = C.VOICE_CHANGER_IRON_LADY
	/** A voice like Crayon Shin-chan.
	 */
	VOICE_CHANGER_SHIN_CHAN VOICE_CONVERSION_PRESET = C.VOICE_CHANGER_SHIN_CHAN
	/** A voice like a castrato.
	 */
	VOICE_CHANGER_GIRLISH_MAN VOICE_CONVERSION_PRESET = C.VOICE_CHANGER_GIRLISH_MAN
	/** A voice like chipmunk.
	 */
	VOICE_CHANGER_CHIPMUNK VOICE_CONVERSION_PRESET = C.VOICE_CHANGER_CHIPMUNK
)

/** The options for SDK preset headphone equalizer.
 */
type HEADPHONE_EQUALIZER_PRESET C.enum_C_HEADPHONE_EQUALIZER_PRESET

const (
	/** Turn off headphone EQ and use the original voice.
	 */
	HEADPHONE_EQUALIZER_OFF HEADPHONE_EQUALIZER_PRESET = C.HEADPHONE_EQUALIZER_OFF
	/** For over-ear headphones.
	 */
	HEADPHONE_EQUALIZER_OVEREAR HEADPHONE_EQUALIZER_PRESET = C.HEADPHONE_EQUALIZER_OVEREAR
	/** For in-ear headphones.
	 */
	HEADPHONE_EQUALIZER_INEAR HEADPHONE_EQUALIZER_PRESET = C.HEADPHONE_EQUALIZER_INEAR
)
 ...
 */
type AUDIO_RECORDING_QUALITY_TYPE C.enum_C_AUDIO_RECORDING_QUALITY_TYPE

const (
	/**
	 * 0: Low quality. The sample rate is 32 kHz, and the file size is around 1.2 MB after 10 minutes of recording.
	 */
	AUDIO_RECORDING_QUALITY_LOW AUDIO_RECORDING_QUALITY_TYPE = C.AUDIO_RECORDING_QUALITY_LOW
	/**
	 * 1: Medium quality. The sample rate is 32 kHz, and the file size is around 2 MB after 10 minutes of recording.
	 */
	AUDIO_RECORDING_QUALITY_MEDIUM AUDIO_RECORDING_QUALITY_TYPE = C.AUDIO_RECORDING_QUALITY_MEDIUM
	/**
	 * 2: High quality. The sample rate is 32 kHz, and the file size is around 3.75 MB after 10 minutes of recording.
	 */
	AUDIO_RECORDING_QUALITY_HIGH AUDIO_RECORDING_QUALITY_TYPE = C.AUDIO_RECORDING_QUALITY_HIGH
	/**
	 * 3: Ultra high audio recording quality.
	 */
	AUDIO_RECORDING_QUALITY_ULTRA_HIGH AUDIO_RECORDING_QUALITY_TYPE = C.AUDIO_RECORDING_QUALITY_ULTRA_HIGH
)

/**
 * Recording content. Set in `startAudioRecording`.
 */
type AUDIO_FILE_RECORDING_TYPE C.enum_C_AUDIO_FILE_RECORDING_TYPE

const (
	/**
	 * 1: Only records the audio of the local user.
	 */
	AUDIO_FILE_RECORDING_MIC AUDIO_FILE_RECORDING_TYPE = C.AUDIO_FILE_RECORDING_MIC
	/**
	 * 2: Only records the audio of all remote users.
	 */
	AUDIO_FILE_RECORDING_PLAYBACK AUDIO_FILE_RECORDING_TYPE = C.AUDIO_FILE_RECORDING_PLAYBACK
	/**
	 * 3: Records the mixed audio of the local and all remote users.
	 */
	AUDIO_FILE_RECORDING_MIXED AUDIO_FILE_RECORDING_TYPE = C.AUDIO_FILE_RECORDING_MIXED
)

/**
 * Audio encoded frame observer position.
 */
type AUDIO_ENCODED_FRAME_OBSERVER_POSITION C.enum_C_AUDIO_ENCODED_FRAME_OBSERVER_POSITION

const (
	/**
	 * 1: Only records the audio of the local user.
	 */
	AUDIO_ENCODED_FRAME_OBSERVER_POSITION_RECORD AUDIO_ENCODED_FRAME_OBSERVER_POSITION = C.AUDIO_ENCODED_FRAME_OBSERVER_POSITION_RECORD
	/**
	 * 2: Only records the audio of all remote users.
	 */
	AUDIO_ENCODED_FRAME_OBSERVER_POSITION_PLAYBACK AUDIO_ENCODED_FRAME_OBSERVER_POSITION = C.AUDIO_ENCODED_FRAME_OBSERVER_POSITION_PLAYBACK
	/**
	 * 3: Records the mixed audio of the local and all remote users.
	 */
	AUDIO_ENCODED_FRAME_OBSERVER_POSITION_MIXED AUDIO_ENCODED_FRAME_OBSERVER_POSITION = C.AUDIO_ENCODED_FRAME_OBSERVER_POSITION_MIXED
)
 ...
 */
type AREA_CODE C.enum_C_AREA_CODE

const (
	/**
	 * Mainland China.
	 */
	AREA_CODE_CN AREA_CODE = C.AREA_CODE_CN
	/**
	 * North America.
	 */
	AREA_CODE_NA AREA_CODE = C.AREA_CODE_NA
	/**
	 * Europe.
	 */
	AREA_CODE_EU AREA_CODE = C.AREA_CODE_EU
	/**
	 * Asia, excluding Mainland China.
	 */
	AREA_CODE_AS AREA_CODE = C.AREA_CODE_AS
	/**
	 * Japan.
	 */
	AREA_CODE_JP AREA_CODE = C.AREA_CODE_JP
	/**
	 * India.
	 */
	AREA_CODE_IN AREA_CODE = C.AREA_CODE_IN
	/**
	 * (Default) Global.
	 */
	AREA_CODE_GLOB AREA_CODE = C.AREA_CODE_GLOB
)

type AREA_CODE_EX C.enum_C_AREA_CODE_EX

const (
	/**
	 * Oceania
	 */
	AREA_CODE_OC AREA_CODE_EX = C.AREA_CODE_OC
	/**
	 * South-American
	 */
	AREA_CODE_SA AREA_CODE_EX = C.AREA_CODE_SA
	/**
	 * Africa
	 */
	AREA_CODE_AF AREA_CODE_EX = C.AREA_CODE_AF
	/**
	 * South Korea
	 */
	AREA_CODE_KR AREA_CODE_EX = C.AREA_CODE_KR
	/**
	 * Hong Kong and Macou
	 */
	AREA_CODE_HKMC AREA_CODE_EX = C.AREA_CODE_HKMC
	/**
	 * United States
	 */
	AREA_CODE_US AREA_CODE_EX = C.AREA_CODE_US
	/**
	 * The global area (except China)
	 */
	AREA_CODE_OVS AREA_CODE_EX = C.AREA_CODE_OVS
)

/**
 * The error code of the channel media replay.
 */
type CHANNEL_MEDIA_RELAY_ERROR C.enum_C_CHANNEL_MEDIA_RELAY_ERROR

const (
	/** 0: No error.
	 */
	RELAY_OK CHANNEL_MEDIA_RELAY_ERROR = C.RELAY_OK
	/** 1: An error occurs in the server response.
	 */
	RELAY_ERROR_SERVER_ERROR_RESPONSE CHANNEL_MEDIA_RELAY_ERROR = C.RELAY_ERROR_SERVER_ERROR_RESPONSE
	 ...
	 */
	RELAY_ERROR_SERVER_NO_RESPONSE CHANNEL_MEDIA_RELAY_ERROR = C.RELAY_ERROR_SERVER_NO_RESPONSE
	/** 3: The SDK fails to access the service, probably due to limited resources of the server.
	 */
	RELAY_ERROR_NO_RESOURCE_AVAILABLE CHANNEL_MEDIA_RELAY_ERROR = C.RELAY_ERROR_NO_RESOURCE_AVAILABLE
	/** 4: Fails to send the relay request.
	 */
	RELAY_ERROR_FAILED_JOIN_SRC CHANNEL_MEDIA_RELAY_ERROR = C.RELAY_ERROR_FAILED_JOIN_SRC
	/** 5: Fails to accept the relay request.
	 */
	RELAY_ERROR_FAILED_JOIN_DEST CHANNEL_MEDIA_RELAY_ERROR = C.RELAY_ERROR_FAILED_JOIN_DEST
	/** 6: The server fails to receive the media stream.
	 */
	RELAY_ERROR_FAILED_PACKET_RECEIVED_FROM_SRC CHANNEL_MEDIA_RELAY_ERROR = C.RELAY_ERROR_FAILED_PACKET_RECEIVED_FROM_SRC
	/** 7: The server fails to send the media stream.
	 */
	RELAY_ERROR_FAILED_PACKET_SENT_TO_DEST CHANNEL_MEDIA_RELAY_ERROR = C.RELAY_ERROR_FAILED_PACKET_SENT_TO_DEST
	/** 8: The SDK disconnects from the server due to poor network connections. You can call the `leaveChannel` method to
	 * leave the channel.
	 */
	RELAY_ERROR_SERVER_CONNECTION_LOST CHANNEL_MEDIA_RELAY_ERROR = C.RELAY_ERROR_SERVER_CONNECTION_LOST
	/** 9: An internal error occurs in the server.
	 */
	RELAY_ERROR_INTERNAL_ERROR CHANNEL_MEDIA_RELAY_ERROR = C.RELAY_ERROR_INTERNAL_ERROR
	/** 10: The token of the source channel has expired.
	 */
	RELAY_ERROR_SRC_TOKEN_EXPIRED CHANNEL_MEDIA_RELAY_ERROR = C.RELAY_ERROR_SRC_TOKEN_EXPIRED
	/** 11: The token of the destination channel has expired.
	 */
	RELAY_ERROR_DEST_TOKEN_EXPIRED CHANNEL_MEDIA_RELAY_ERROR = C.RELAY_ERROR_DEST_TOKEN_EXPIRED
)

/**
 * The event code of channel media relay.
 */
type CHANNEL_MEDIA_RELAY_EVENT C.enum_C_CHANNEL_MEDIA_RELAY_EVENT

const (
	/** 0: The user disconnects from the server due to poor network connections.
	 */
	RELAY_EVENT_NETWORK_DISCONNECTED CHANNEL_MEDIA_RELAY_EVENT = C.RELAY_EVENT_NETWORK_DISCONNECTED
	/** 1: The user is connected to the server.
	 */
	RELAY_EVENT_NETWORK_CONNECTED CHANNEL_MEDIA_RELAY_EVENT = C.RELAY_EVENT_NETWORK_CONNECTED
	/** 2: The user joins the source channel.
	 */
	RELAY_EVENT_PACKET_JOINED_SRC_CHANNEL CHANNEL_MEDIA_RELAY_EVENT = C.RELAY_EVENT_PACKET_JOINED_SRC_CHANNEL
	/** 3: The user joins the destination channel.
	 */
	RELAY_EVENT_PACKET_JOINED_DEST_CHANNEL CHANNEL_MEDIA_RELAY_EVENT = C.RELAY_EVENT_PACKET_JOINED_DEST_CHANNEL
	/** 4: The SDK starts relaying the media stream to the destination channel.
	 */
	RELAY_EVENT_PACKET_SENT_TO_DEST_CHANNEL CHANNEL_MEDIA_RELAY_EVENT = C.RELAY_EVENT_PACKET_SENT_TO_DEST_CHANNEL
	/** 5: The server receives the video stream from the source channel.
	 */
	RELAY_EVENT_PACKET_RECEIVED_VIDEO_FROM_SRC CHANNEL_MEDIA_RELAY_EVENT = C.RELAY_EVENT_PACKET_RECEIVED_VIDEO_FROM_SRC
	/** 6: The server receives the audio stream from the source channel.
	 */
	RELAY_EVENT_PACKET_RECEIVED_AUDIO_FROM_SRC CHANNEL_MEDIA_RELAY_EVENT = C.RELAY_EVENT_PACKET_RECEIVED_AUDIO_FROM_SRC
	/** 7: The destination channel is updated.
	 */
	RELAY_EVENT_PACKET_UPDATE_DEST_CHANNEL CHANNEL_MEDIA_RELAY_EVENT = C.RELAY_EVENT_PACKET_UPDATE_DEST_CHANNEL
	/** 8: The destination channel update fails due to internal reasons.
	 */
	RELAY_EVENT_PACKET_UPDATE_DEST_CHANNEL_REFUSED CHANNEL_MEDIA_RELAY_EVENT = C.RELAY_EVENT_PACKET_UPDATE_DEST_CHANNEL_REFUSED
	/** 9: The destination channel does not change, which means that the destination channel fails to be updated.
	 */
	RELAY_EVENT_PACKET_UPDATE_DEST_CHANNEL_NOT_CHANGE CHANNEL_MEDIA_RELAY_EVENT = C.RELAY_EVENT_PACKET_UPDATE_DEST_CHANNEL_NOT_CHANGE
	/** 10: The destination channel name is NULL.
	 */
	RELAY_EVENT_PACKET_UPDATE_DEST_CHANNEL_IS_NULL CHANNEL_MEDIA_RELAY_EVENT = C.RELAY_EVENT_PACKET_UPDATE_DEST_CHANNEL_IS_NULL
	/** 11: The video profile is sent to the server.
	 */
	RELAY_EVENT_VIDEO_PROFILE_UPDATE CHANNEL_MEDIA_RELAY_EVENT = C.RELAY_EVENT_VIDEO_PROFILE_UPDATE
	/** 12: The SDK successfully pauses relaying the media stream to destination channels.
	 */
	RELAY_EVENT_PAUSE_SEND_PACKET_TO_DEST_CHANNEL_SUCCESS CHANNEL_MEDIA_RELAY_EVENT = C.RELAY_EVENT_PAUSE_SEND_PACKET_TO_DEST_CHANNEL_SUCCESS
	/** 13: The SDK fails to pause relaying the media stream to destination channels.
	 */
	RELAY_EVENT_PAUSE_SEND_PACKET_TO_DEST_CHANNEL_FAILED CHANNEL_MEDIA_RELAY_EVENT = C.RELAY_EVENT_PAUSE_SEND_PACKET_TO_DEST_CHANNEL_FAILED
	/** 14: The SDK successfully resumes relaying the media stream to destination channels.
	 */
	RELAY_EVENT_RESUME_SEND_PACKET_TO_DEST_CHANNEL_SUCCESS CHANNEL_MEDIA_RELAY_EVENT = C.RELAY_EVENT_RESUME_SEND_PACKET_TO_DEST_CHANNEL_SUCCESS
	/** 15: The SDK fails to resume relaying the media stream to destination channels.
	 */
	RELAY_EVENT_RESUME_SEND_PACKET_TO_DEST_CHANNEL_FAILED CHANNEL_MEDIA_RELAY_EVENT = C.RELAY_EVENT_RESUME_SEND_PACKET_TO_DEST_CHANNEL_FAILED
)

/**
 * The state code of the channel media relay.
 */
type CHANNEL_MEDIA_RELAY_STATE C.enum_C_CHANNEL_MEDIA_RELAY_STATE
...
const (
	 ...
	 */
	RELAY_STATE_IDLE CHANNEL_MEDIA_RELAY_STATE = C.RELAY_STATE_IDLE
	/** 1: The SDK tries to relay the media stream to the destination channel.
	 */
	RELAY_STATE_CONNECTING CHANNEL_MEDIA_RELAY_STATE = C.RELAY_STATE_CONNECTING
	/** 2: The SDK successfully relays the media stream to the destination channel.
	 */
	RELAY_STATE_RUNNING CHANNEL_MEDIA_RELAY_STATE = C.RELAY_STATE_RUNNING
	/** 3: An error occurs. See `code` in `onChannelMediaRelayStateChanged` for the error code.
	 */
	RELAY_STATE_FAILURE CHANNEL_MEDIA_RELAY_STATE = C.RELAY_STATE_FAILURE
)
 ...
 */
type ENCRYPTION_MODE C.enum_C_ENCRYPTION_MODE

const (
	/** 1: 128-bit AES encryption, XTS mode.
	 */
	AES_128_XTS ENCRYPTION_MODE = C.AES_128_XTS
	/** 2: 128-bit AES encryption, ECB mode.
	 */
	AES_128_ECB ENCRYPTION_MODE = C.AES_128_ECB
	/** 3: 256-bit AES encryption, XTS mode.
	 */
	AES_256_XTS ENCRYPTION_MODE = C.AES_256_XTS
	/** 4: 128-bit SM4 encryption, ECB mode.
	 */
	SM4_128_ECB ENCRYPTION_MODE = C.SM4_128_ECB
	/** 5: 128-bit AES encryption, GCM mode.
	 */
	AES_128_GCM ENCRYPTION_MODE = C.AES_128_GCM
	/** 6: 256-bit AES encryption, GCM mode.
	 */
	AES_256_GCM ENCRYPTION_MODE = C.AES_256_GCM
	/** 7: (Default) 128-bit AES encryption, GCM mode. This encryption mode requires the setting of
	 * salt (`encryptionKdfSalt`).
	 */
	AES_128_GCM2 ENCRYPTION_MODE = C.AES_128_GCM2
	/** 8: 256-bit AES encryption, GCM mode. This encryption mode requires the setting of salt (`encryptionKdfSalt`).
	 */
	AES_256_GCM2 ENCRYPTION_MODE = C.AES_256_GCM2
	/** Enumerator boundary.
	 */
	MODE_END ENCRYPTION_MODE = C.MODE_END
)
 ...
 */
type ENCRYPTION_ERROR_TYPE C.enum_C_ENCRYPTION_ERROR_TYPE

const (
	/**
	 * 0: Internal reason.
	 */
	ENCRYPTION_ERROR_INTERNAL_FAILURE ENCRYPTION_ERROR_TYPE = C.ENCRYPTION_ERROR_INTERNAL_FAILURE
	/**
	 * 1: MediaStream decryption errors. Ensure that the receiver and the sender use the same encryption mode and key.
	 */
	ENCRYPTION_ERROR_DECRYPTION_FAILURE ENCRYPTION_ERROR_TYPE = C.ENCRYPTION_ERROR_DECRYPTION_FAILURE
	/**
	 * 2: MediaStream encryption errors.
	 */
	ENCRYPTION_ERROR_ENCRYPTION_FAILURE ENCRYPTION_ERROR_TYPE = C.ENCRYPTION_ERROR_ENCRYPTION_FAILURE
	/**
	 * 3: DataStream decryption errors. Ensure that the receiver and the sender use the same encryption mode and key.
	 */
	ENCRYPTION_ERROR_DATASTREAM_DECRYPTION_FAILURE ENCRYPTION_ERROR_TYPE = C.ENCRYPTION_ERROR_DATASTREAM_DECRYPTION_FAILURE
	/**
	 * 4: DataStream encryption errors.
	 */
	ENCRYPTION_ERROR_DATASTREAM_ENCRYPTION_FAILURE ENCRYPTION_ERROR_TYPE = C.ENCRYPTION_ERROR_DATASTREAM_ENCRYPTION_FAILURE
)

type UPLOAD_ERROR_REASON C.enum_C_UPLOAD_ERROR_REASON

const (
	UPLOAD_SUCCESS      UPLOAD_ERROR_REASON = C.UPLOAD_SUCCESS
	UPLOAD_NET_ERROR    UPLOAD_ERROR_REASON = C.UPLOAD_NET_ERROR
	UPLOAD_SERVER_ERROR UPLOAD_ERROR_REASON = C.UPLOAD_SERVER_ERROR
)

/** The type of the device permission.
 */
type PERMISSION_TYPE C.enum_C_PERMISSION_TYPE

const (
	/**
	 * 0: Permission for the audio capture device.
	 */
	RECORD_AUDIO PERMISSION_TYPE = C.RECORD_AUDIO
	/**
	 * 1: Permission for the camera.
	 */
	CAMERA PERMISSION_TYPE = C.CAMERA

	SCREEN_CAPTURE PERMISSION_TYPE = C.SCREEN_CAPTURE
)

/** The maximum length of the user account.
 */
type MAX_USER_ACCOUNT_LENGTH_TYPE C.enum_C_MAX_USER_ACCOUNT_LENGTH_TYPE

const (
	/** The maximum length of the user account is 256 bytes.
	 */
	MAX_USER_ACCOUNT_LENGTH MAX_USER_ACCOUNT_LENGTH_TYPE = C.MAX_USER_ACCOUNT_LENGTH
)

/**
 * The subscribing state.
 */
type STREAM_SUBSCRIBE_STATE C.enum_C_STREAM_SUBSCRIBE_STATE

const (
	/**
	 * 0: The initial subscribing state after joining the channel.
	 */
	SUB_STATE_IDLE STREAM_SUBSCRIBE_STATE = C.SUB_STATE_IDLE
	/**
	 ...
	 */
	SUB_STATE_NO_SUBSCRIBED STREAM_SUBSCRIBE_STATE = C.SUB_STATE_NO_SUBSCRIBED
	/**
	 * 2: Subscribing.
	 */
	SUB_STATE_SUBSCRIBING STREAM_SUBSCRIBE_STATE = C.SUB_STATE_SUBSCRIBING
	/**
	 * 3: Subscribes to and receives the remote stream successfully.
	 */
	SUB_STATE_SUBSCRIBED STREAM_SUBSCRIBE_STATE = C.SUB_STATE_SUBSCRIBED
)

/**
 * The publishing state.
 */
type STREAM_PUBLISH_STATE C.enum_C_STREAM_PUBLISH_STATE

const (
	/**
	 * 0: The initial publishing state after joining the channel.
	 */
	PUB_STATE_IDLE STREAM_PUBLISH_STATE = C.PUB_STATE_IDLE
	/**
	 ...
	 */
	PUB_STATE_NO_PUBLISHED STREAM_PUBLISH_STATE = C.PUB_STATE_NO_PUBLISHED
	/**
	 * 2: Publishing.
	 */
	PUB_STATE_PUBLISHING STREAM_PUBLISH_STATE = C.PUB_STATE_PUBLISHING
	/**
	 * 3: Publishes successfully.
	 */
	PUB_STATE_PUBLISHED STREAM_PUBLISH_STATE = C.PUB_STATE_PUBLISHED
)
 ...
 */
type EAR_MONITORING_FILTER_TYPE C.enum_C_EAR_MONITORING_FILTER_TYPE

const (
	/**
	 * 1: Do not add an audio filter to the in-ear monitor.
	 */
	EAR_MONITORING_FILTER_NONE EAR_MONITORING_FILTER_TYPE = C.EAR_MONITORING_FILTER_NONE
	/**
	 ...
	 */
	EAR_MONITORING_FILTER_BUILT_IN_AUDIO_FILTERS EAR_MONITORING_FILTER_TYPE = C.EAR_MONITORING_FILTER_BUILT_IN_AUDIO_FILTERS
	/**
	 * 4: Enable noise suppression to the in-ear monitor.
	 */
	EAR_MONITORING_FILTER_NOISE_SUPPRESSION EAR_MONITORING_FILTER_TYPE = C.EAR_MONITORING_FILTER_NOISE_SUPPRESSION
	/**
	 * 32768: Enable audio filters by reuse post-processing filter to the in-ear monitor.
	 */
	EAR_MONITORING_FILTER_REUSE_POST_PROCESSING_FILTER EAR_MONITORING_FILTER_TYPE = C.EAR_MONITORING_FILTER_REUSE_POST_PROCESSING_FILTER
)

/**
 * Thread priority type.
 */
type THREAD_PRIORITY_TYPE C.enum_C_THREAD_PRIORITY_TYPE

const (
	/**
	 * 0: Lowest priority.
	 */
	LOWEST THREAD_PRIORITY_TYPE = C.LOWEST
	/**
	 * 1: Low priority.
	 */
	LOW THREAD_PRIORITY_TYPE = C.LOW
	/**
	 * 2: Normal priority.
	 */
	NORMAL THREAD_PRIORITY_TYPE = C.NORMAL
	/**
	 * 3: High priority.
	 */
	HIGH THREAD_PRIORITY_TYPE = C.HIGH
	/**
	 * 4. Highest priority.
	 */
	HIGHEST THREAD_PRIORITY_TYPE = C.HIGHEST
	/**
	 * 5. Critical priority.
	 */
	CRITICAL THREAD_PRIORITY_TYPE = C.CRITICAL
)
 ...
 */
type MEDIA_TRACE_EVENT C.enum_C_MEDIA_TRACE_EVENT

const (
	/**
	 * 0: The media frame has been rendered.
	 */
	MEDIA_TRACE_EVENT_VIDEO_RENDERED MEDIA_TRACE_EVENT = C.MEDIA_TRACE_EVENT_VIDEO_RENDERED
	/**
	 * 1: The media frame has been decoded.
	 */
	MEDIA_TRACE_EVENT_VIDEO_DECODED MEDIA_TRACE_EVENT = C.MEDIA_TRACE_EVENT_VIDEO_DECODED
)

/**
 * The video rendering tracing result
 */
type VideoRenderingTracingInfo C.struct_C_VideoRenderingTracingInfo
...
type CONFIG_FETCH_TYPE C.enum_C_CONFIG_FETCH_TYPE

const (
	/**
	 * 1: Fetch config when initializing RtcEngine, without channel info.
	 */
	CONFIG_FETCH_TYPE_INITIALIZE CONFIG_FETCH_TYPE = C.CONFIG_FETCH_TYPE_INITIALIZE
	/**
	 * 2: Fetch config when joining channel with channel info, such as channel name and uid.
	 */
	CONFIG_FETCH_TYPE_JOIN_CHANNEL CONFIG_FETCH_TYPE = C.CONFIG_FETCH_TYPE_JOIN_CHANNEL
)
...
type LOCAL_PROXY_MODE C.enum_C_LOCAL_PROXY_MODE

const (
	/** 0: Connect local proxy with high priority, if not connected to local proxy, fallback to sdrtn.
	 */
	ConnectivityFirst LOCAL_PROXY_MODE = C.ConnectivityFirst
	/** 1: Only connect local proxy
	 */
	LocalOnly LOCAL_PROXY_MODE = C.LocalOnly
)
...
type SpatialAudioParams C.struct_C_SpatialAudioParams

// #region SpatialAudioParams

/**
 * Speaker azimuth in a spherical coordinate system centered on the listener.
 */
func (this_ *SpatialAudioParams) GetSpeakerAzimuth() float64 {
	return float64(this_.speaker_azimuth)
}

/**
 * Speaker azimuth in a spherical coordinate system centered on the listener.
 */
func (this_ *SpatialAudioParams) SetSpeakerAzimuth(speaker_azimuth float64) {
	this_.speaker_azimuth = C.double(speaker_azimuth)
}

/**
 * Speaker elevation in a spherical coordinate system centered on the listener.
 */
func (this_ *SpatialAudioParams) GetSpeakerElevation() float64 {
	return float64(this_.speaker_elevation)
}

/**
 * Speaker elevation in a spherical coordinate system centered on the listener.
 */
func (this_ *SpatialAudioParams) SetSpeakerElevation(speaker_elevation float64) {
	this_.speaker_elevation = C.double(speaker_elevation)
}

/**
 * Distance between speaker and listener.
 */
func (this_ *SpatialAudioParams) GetSpeakerDistance() float64 {
	return float64(this_.speaker_distance)
}

/**
 * Distance between speaker and listener.
 */
func (this_ *SpatialAudioParams) SetSpeakerDistance(speaker_distance float64) {
	this_.speaker_distance = C.double(speaker_distance)
}

/**
 * Speaker orientation [0-180], 0 degree is the same with listener orientation.
 */
func (this_ *SpatialAudioParams) GetSpeakerOrientation() int {
	return int(this_.speaker_orientation)
}

/**
 * Speaker orientation [0-180], 0 degree is the same with listener orientation.
 */
func (this_ *SpatialAudioParams) SetSpeakerOrientation(speaker_orientation int) {
	this_.speaker_orientation = C.int(speaker_orientation)
}

/**
 * Enable blur or not for the speaker.
 */
func (this_ *SpatialAudioParams) GetEnableBlur() bool {
	return bool(this_.enable_blur)
}

/**
 * Enable blur or not for the speaker.
 */
func (this_ *SpatialAudioParams) SetEnableBlur(enable_blur bool) {
	this_.enable_blur = C.bool(enable_blur)
}

/**
 * Enable air absorb or not for the speaker.
 */
func (this_ *SpatialAudioParams) GetEnableAirAbsorb() bool {
	return bool(this_.enable_air_absorb)
}

/**
 * Enable air absorb or not for the speaker.
 */
func (this_ *SpatialAudioParams) SetEnableAirAbsorb(enable_air_absorb bool) {
	this_.enable_air_absorb = C.bool(enable_air_absorb)
}

/**
 * Speaker attenuation factor.
 */
func (this_ *SpatialAudioParams) GetSpeakerAttenuation() float64 {
	return float64(this_.speaker_attenuation)
}

/**
 * Speaker attenuation factor.
 */
func (this_ *SpatialAudioParams) SetSpeakerAttenuation(speaker_attenuation float64) {
	this_.speaker_attenuation = C.double(speaker_attenuation)
}

/**
 * Enable doppler factor.
 */
func (this_ *SpatialAudioParams) GetEnableDoppler() bool {
	return bool(this_.enable_doppler)
}

/**
 * Enable doppler factor.
 */
func (this_ *SpatialAudioParams) SetEnableDoppler(enable_doppler bool) {
	this_.enable_doppler = C.bool(enable_doppler)
}

func NewSpatialAudioParams() *SpatialAudioParams {
	return (*SpatialAudioParams)(C.C_SpatialAudioParams_New())
}
func (this_ *SpatialAudioParams) Delete() {
	C.C_SpatialAudioParams_Delete((*C.struct_C_SpatialAudioParams)(this_))
}

// #endregion SpatialAudioParams
 ...
 */
func GetAgoraSdkVersion() (int, string) {
	var build C.int
	version := C.C_getAgoraSdkVersion(&build)
	return int(build), C.GoString(version)
}
 ...
 */
func GetAgoraSdkErrorDescription(err int) string {
	return C.GoString(C.C_getAgoraSdkErrorDescription(C.int(err)))
}
 ...
 * - < 0: Failure.
 */
func GetAgoraCurrentMonotonicTimeInMs() int64 {
	return int64(C.C_getAgoraCurrentMonotonicTimeInMs())
}
